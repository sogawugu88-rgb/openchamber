...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'taskboard.eyebrow': 'Fluxo do projeto',
  'taskboard.title': 'Quadro de tarefas',
  'taskboard.description': 'Coloque o trabalho do projeto em sessões independentes do OpenCode e revise o resultado antes de aceitá-lo.',
  'taskboard.project.placeholder': 'Escolher projeto',
  'taskboard.project.all': 'Todos os projetos',
  'taskboard.aggregate.partial': 'Não foi possível carregar alguns quadros de projeto.',
  'taskboard.actions.new': 'Nova tarefa',
  'taskboard.actions.edit': 'Editar',
  'taskboard.actions.delete': 'Excluir',
  'taskboard.actions.refresh': 'Atualizar',
  'taskboard.actions.retry': 'Tentar novamente',
  'taskboard.actions.openSession': 'Abrir sessão',
  'taskboard.actions.run': 'Executar agora',
  'taskboard.automation.label': 'Execução automática',
  'taskboard.automation.description': 'Somente tarefas em Todo são coletadas automaticamente.',
  'taskboard.automation.enabled': 'Ativada',
  'taskboard.automation.disabled': 'Desativada',
  'taskboard.columns.backlog': 'Backlog',
  'taskboard.columns.todo': 'Todo',
  'taskboard.columns.inProgress': 'Em andamento',
  'taskboard.columns.inReview': 'Em revisão',
  'taskboard.columns.blocked': 'Bloqueada',
  'taskboard.columns.done': 'Concluída',
  'taskboard.status.backlog': 'Backlog',
  'taskboard.status.todo': 'Todo',
  'taskboard.status.in_progress': 'Em andamento',
  'taskboard.status.in_review': 'Em revisão',
  'taskboard.status.blocked': 'Bloqueada',
  'taskboard.status.done': 'Concluída',
  'taskboard.status.canceled': 'Cancelada',
  'taskboard.priority.none': 'Sem prioridade',
  'taskboard.priority.urgent': 'Urgente',
  'taskboard.priority.high': 'Alta',
  'taskboard.priority.medium': 'Média',
  'taskboard.priority.low': 'Baixa',
  'taskboard.empty.title': 'Nenhuma tarefa ainda',
  'taskboard.loading': 'Carregando quadro de tarefas...',
  'taskboard.empty.description': 'Crie uma tarefa, mova-a para Todo quando estiver pronta e deixe o worker iniciar uma sessão independente.',
  'taskboard.empty.column': 'Nenhuma tarefa',
  'taskboard.card.blockedBy': 'Aguardando dependências',
  'taskboard.card.running': 'O agente está trabalhando',
  'taskboard.card.runSucceeded': 'Execução concluída',
  'taskboard.card.runFailed': 'Falha na execução',
  'taskboard.card.scheduled': 'Agendada',
  'taskboard.toast.created': 'Tarefa criada',
  'taskboard.toast.moved': 'Status da tarefa atualizado',
  'taskboard.toast.runStarted': 'Execução da tarefa iniciada',
  'taskboard.toast.failed': 'Falha na ação do quadro',
  'taskboard.toast.updated': 'Tarefa atualizada',
  'taskboard.toast.deleted': 'Tarefa excluída',
  'taskboard.dialog.title': 'Criar tarefa',
  'taskboard.dialog.editTitle': 'Editar tarefa',
  'taskboard.dialog.description': 'Adicione uma tarefa do projeto. Tarefas no Backlog permanecem manuais até serem movidas para Todo.',
  'taskboard.dialog.fields.title': 'Título',
  'taskboard.dialog.fields.titlePlaceholder': 'O que precisa ser feito?',
  'taskboard.dialog.fields.project': 'Projeto',
  'taskboard.dialog.fields.model': 'Modelo',
  'taskboard.dialog.fields.agent': 'Agente',
  'taskboard.dialog.fields.goalEnabled': 'Ativar o modo Goal',
  'taskboard.dialog.fields.schedule': 'Agendamento',
  'taskboard.dialog.fields.date': 'Data',
  'taskboard.dialog.fields.time': 'Hora',
  'taskboard.dialog.fields.timezone': 'Fuso horário',
  'taskboard.dialog.fields.context': 'Transferência de contexto',
  'taskboard.dialog.fields.sourceSession': 'Sessão de origem',
  'taskboard.dialog.context.new': 'Iniciar uma nova sessão',
  'taskboard.dialog.context.fork': 'Criar fork da sessão',
  'taskboard.dialog.context.handoff': 'Escrever transferência local',
  'taskboard.dialog.sourceSessionPlaceholder': 'Buscar sessões por título ou ID',
  'taskboard.dialog.sourceSessionNoResults': 'Nenhuma sessão correspondente.',
  'taskboard.dialog.validation.sourceSessionRequired': 'Escolha uma sessão de origem.',
  'taskboard.dialog.schedule.none': 'Sem agendamento',
  'taskboard.dialog.schedule.once': 'Executar uma vez',
  'taskboard.dialog.schedule.daily': 'Todos os dias',
  'taskboard.schedule.title': 'Modelos de tarefas agendadas',
  'taskboard.schedule.description': 'Esses modelos criam tarefas comuns quando chega o horário.',
  'taskboard.schedule.once': 'Uma vez',
  'taskboard.schedule.daily': 'Diária',
  'taskboard.dialog.validation.projectRequired': 'Escolha um projeto.',
  'taskboard.dialog.validation.modelRequired': 'Escolha um modelo.',
  'taskboard.dialog.validation.agentRequired': 'Escolha um agente.',
  'taskboard.dialog.validation.goalObjectiveRequired': 'Digite o objetivo do Goal.',
  'taskboard.dialog.fields.description': 'Descrição',
  'taskboard.dialog.fields.descriptionPlaceholder': 'Adicione contexto e critérios de aceitação para o agente.',
  'taskboard.dialog.fields.labels': 'Etiquetas',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp, backend, acompanhamento',
  'taskboard.dialog.fields.priority': 'Prioridade',
  'taskboard.dialog.fields.status': 'Status inicial',
  'taskboard.dialog.actions.cancel': 'Cancelar',
  'taskboard.dialog.actions.create': 'Criar tarefa',
  'taskboard.dialog.actions.creating': 'Criando...',
  'taskboard.dialog.actions.save': 'Salvar alterações',
  'taskboard.dialog.actions.saving': 'Salvando...',
  'taskboard.project.noResults': 'Nenhum projeto correspondente.',
  'taskboard.delete.title': 'Excluir tarefa?',
  'taskboard.delete.description': 'Esta tarefa ainda não começou e pode ser excluída permanentemente.',
  'taskboard.delete.cancel': 'Cancelar',
  'taskboard.delete.confirm': 'Excluir tarefa',
  'terminalView.actions.attachSelection': 'Anexar saída selecionada',
  'terminalView.actions.restart': 'Reiniciar terminal',
  'terminalView.actions.uploadFiles': 'Enviar arquivos para o diretório atual',
  'terminalView.upload.success': 'Arquivos enviados: {count}.',
  'terminalView.upload.conflict': 'Arquivos existentes não substituídos: {count}.',
  'terminalView.upload.failed': 'Falhas no envio: {count}.',
  'terminalView.upload.chooseDirectory': 'Escolher diretório de envio',
  'terminalView.upload.chooseDirectoryDescription': 'Selecione um diretório do servidor para os arquivos.',
  'terminalView.upload.currentDirectory': 'Diretório do servidor',
  'terminalView.upload.parentDirectory': 'Ir para o diretório pai',
  'terminalView.upload.selectDirectory': 'Escolher este diretório e enviar',
  'terminalView.upload.directoryLoading': 'Carregando diretórios...',
  'terminalView.upload.directoryEmpty': 'Nenhum subdiretório',
  'terminalView.upload.directoryLoadFailed': 'Não foi possível carregar este diretório.',
  'terminalView.upload.directoryRetry': 'Tentar novamente',
  ...
  "settings.usage.tokenUsage.title": "Uso de tokens",
  "settings.usage.tokenUsage.today": "Hoje",
  "settings.usage.tokenUsage.thisMonth": "Este mês",
  "settings.usage.tokenUsage.total": "Total",
  "settings.usage.tokenUsage.previousMonth": "Mês anterior",
  "settings.usage.tokenUsage.nextMonth": "Próximo mês",
  "settings.usage.tokenUsage.noData": "Não há dados de uso de tokens para este mês.",
  "settings.usage.tokenUsage.loading": "Carregando uso de tokens...",
  "settings.usage.tokenUsage.retry": "Tentar novamente",
  "settings.usage.tokenUsage.timezone": "Fuso horário do serviço: {timezone}",
  "settings.usage.tokenUsage.recentDays": "Últimos 14 dias",
  "settings.usage.tokenUsage.date": "Data",
  "settings.usage.tokenUsage.share": "Participação",
  "settings.usage.tokenUsage.modelShare": "Participação: {percent}%",
  "settings.usage.tokenUsage.modelDetails": "Detalhes do modelo",
  "settings.usage.tokenUsage.modelDetailsForDate": "Detalhes dos modelos para {date}",
  "settings.usage.tokenUsage.providerModel": "Provedor / modelo",
  "settings.usage.tokenUsage.selectDate": "Mostrar detalhes dos tokens para {date}",
  "settings.usage.tokenUsage.noModelDetails": "Não há detalhes de modelo para esta data.",
  ...
  "chat.sessionMetrics.tokens": "Uso da sessão",
  "chat.sessionMetrics.turns": "Turnos",
  "chat.sessionMetrics.steps": "Etapas",
  "chat.sessionMetrics.cacheTokens": "Cache",
  "chat.sessionMetrics.llm": "LLM",
  "chat.sessionMetrics.tools": "Ferramentas",
