...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.autoContinue.sectionTitle': '自动继续',
  'settings.openchamber.visual.autoContinue.description': '当提供商限流导致一轮对话结束时，OpenChamber 可以在同一会话中发送新的合成继续消息。仅适用于普通对话，不适用于目标模式。',
  'settings.openchamber.visual.autoContinue.enabled': '限流后自动继续',
  'settings.openchamber.visual.autoContinue.enabledAria': '提供商限流后自动继续普通对话',
  'settings.openchamber.visual.autoContinue.maxRetries': '最多发送的继续消息数',
  'settings.openchamber.visual.autoContinue.maxRetriesInfo': '对于一次限流失败，OpenChamber 最多发送你设置数量的新继续消息，默认值为 5。设置为 0 可禁用自动恢复。',
  'settings.openchamber.visual.autoContinue.maxRetriesAria': '自动继续消息的最大数量',
  'settings.openchamber.visual.autoContinue.prompt': '继续消息',
  'settings.openchamber.visual.autoContinue.promptInfo': '限流失败后，这段文字会作为合成用户消息发送。留空将使用内置消息。',
  'settings.openchamber.visual.autoContinue.promptPlaceholder': '留空以使用默认继续消息',
  'settings.openchamber.visual.autoContinue.promptAria': '提供商限流后发送的继续消息',
  'settings.openchamber.visual.goal.auditFailureLimitLabel': '阻塞前允许的审核失败次数',
  'settings.openchamber.visual.goal.auditFailureLimitAria': '阻塞前允许的连续 Goal 审核失败次数',
  'settings.openchamber.visual.goal.auditFailureLimitDescription': '设置 Goal 模式在连续审核不可用或触发限流后，允许继续运行的次数。达到此次数后会标记为阻塞。范围：1 到 20。',
  'settings.openchamber.visual.codeServer.sectionTitle': '云端 code-server',
  'settings.openchamber.visual.codeServer.label': '基础地址',
  'settings.openchamber.visual.codeServer.aria': '云端 code-server 基础地址',
  'settings.openchamber.visual.codeServer.description': '设置云端 code-server 的基础地址。打开项目时，当前项目目录会自动作为 folder 参数添加。',
  ...
  'settings.openchamber.visual.field.showSessionTokenDetailsAria': '在 Composer 中显示会话 Token 详情',
  'settings.openchamber.visual.field.showSessionTokenDetails': '显示会话 Token 详情',
  'settings.openchamber.visual.field.showSessionTokenDetailsInfo': '回复后在 Composer 下方显示 Token 和耗时指标。',
