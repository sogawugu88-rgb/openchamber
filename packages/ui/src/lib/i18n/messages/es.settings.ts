...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.autoContinue.sectionTitle": "Continuación automática",
  "settings.openchamber.visual.autoContinue.description": "Cuando un límite del proveedor termina un turno, OpenChamber puede enviar un nuevo mensaje sintético de continuación en la misma sesión. Solo se aplica a conversaciones normales, no al modo objetivo.",
  "settings.openchamber.visual.autoContinue.enabled": "Continuar automáticamente después de límites del proveedor",
  "settings.openchamber.visual.autoContinue.enabledAria": "Continuar automáticamente las conversaciones normales después de un límite del proveedor",
  "settings.openchamber.visual.autoContinue.maxRetries": "Máximo de mensajes de continuación",
  "settings.openchamber.visual.autoContinue.maxRetriesInfo": "OpenChamber envía el número configurado de mensajes nuevos de continuación por cada turno limitado. El valor predeterminado es 5; establece 0 para desactivar la recuperación automática.",
  "settings.openchamber.visual.autoContinue.maxRetriesAria": "Máximo de mensajes de continuación automática",
  "settings.openchamber.visual.autoContinue.prompt": "Mensaje de continuación",
  "settings.openchamber.visual.autoContinue.promptInfo": "Este mensaje se envía como mensaje de usuario sintético después de un fallo por límite. Déjalo vacío para usar el mensaje integrado.",
  "settings.openchamber.visual.autoContinue.promptPlaceholder": "Déjalo vacío para usar el mensaje de continuación predeterminado",
  "settings.openchamber.visual.autoContinue.promptAria": "Mensaje enviado para continuar después de un límite del proveedor",
  "settings.openchamber.visual.goal.auditFailureLimitLabel": "Fallos de auditoría antes de bloquear",
  "settings.openchamber.visual.goal.auditFailureLimitAria": "Número de fallos consecutivos de auditoría de Goal tolerados antes de bloquear",
  "settings.openchamber.visual.goal.auditFailureLimitDescription": "Controla cuántas llamadas de auditoría no disponibles o limitadas consecutivas tolera Goal Mode antes de bloquearse. Rango: 1 a 20.",
  "settings.openchamber.visual.codeServer.sectionTitle": "code-server en la nube",
  "settings.openchamber.visual.codeServer.label": "URL base",
  "settings.openchamber.visual.codeServer.aria": "URL base del code-server en la nube",
  "settings.openchamber.visual.codeServer.description": "Define la URL base del code-server en la nube. El directorio del proyecto actual se añade como parámetro folder al abrirlo.",
  ...
  "settings.openchamber.visual.field.showSessionTokenDetailsAria": "Mostrar detalles de tokens de la sesión en el Composer",
  "settings.openchamber.visual.field.showSessionTokenDetails": "Mostrar detalles de tokens de la sesión",
  "settings.openchamber.visual.field.showSessionTokenDetailsInfo": "Mostrar las métricas de tokens y tiempo debajo del Composer después de una respuesta.",
