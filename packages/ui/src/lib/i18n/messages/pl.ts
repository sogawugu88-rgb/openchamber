...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'taskboard.eyebrow': 'Przebieg projektu',
  'taskboard.title': 'Tablica zadań',
  'taskboard.description': 'Kolejkuj pracę projektu w niezależnych sesjach OpenCode i sprawdzaj wynik przed akceptacją.',
  'taskboard.project.placeholder': 'Wybierz projekt',
  'taskboard.project.all': 'Wszystkie projekty',
  'taskboard.aggregate.partial': 'Nie udało się załadować niektórych tablic projektów.',
  'taskboard.actions.new': 'Nowe zadanie',
  'taskboard.actions.edit': 'Edytuj',
  'taskboard.actions.delete': 'Usuń',
  'taskboard.actions.refresh': 'Odśwież',
  'taskboard.actions.retry': 'Spróbuj ponownie',
  'taskboard.actions.openSession': 'Otwórz sesję',
  'taskboard.actions.run': 'Uruchom teraz',
  'taskboard.automation.label': 'Automatyczne wykonanie',
  'taskboard.automation.description': 'Automatycznie pobierane są tylko zadania w Todo.',
  'taskboard.automation.enabled': 'Włączone',
  'taskboard.automation.disabled': 'Wyłączone',
  'taskboard.columns.backlog': 'Backlog',
  'taskboard.columns.todo': 'Todo',
  'taskboard.columns.inProgress': 'W toku',
  'taskboard.columns.inReview': 'W przeglądzie',
  'taskboard.columns.blocked': 'Zablokowane',
  'taskboard.columns.done': 'Gotowe',
  'taskboard.status.backlog': 'Backlog',
  'taskboard.status.todo': 'Todo',
  'taskboard.status.in_progress': 'W toku',
  'taskboard.status.in_review': 'W przeglądzie',
  'taskboard.status.blocked': 'Zablokowane',
  'taskboard.status.done': 'Gotowe',
  'taskboard.status.canceled': 'Anulowane',
  'taskboard.priority.none': 'Brak priorytetu',
  'taskboard.priority.urgent': 'Pilne',
  'taskboard.priority.high': 'Wysoki',
  'taskboard.priority.medium': 'Średni',
  'taskboard.priority.low': 'Niski',
  'taskboard.empty.title': 'Brak zadań',
  'taskboard.loading': 'Ładowanie tablicy zadań...',
  'taskboard.empty.description': 'Utwórz zadanie, przenieś je do Todo, gdy będzie gotowe, a worker uruchomi niezależną sesję.',
  'taskboard.empty.column': 'Brak zadań',
  'taskboard.card.blockedBy': 'Oczekiwanie na zależności',
  'taskboard.card.running': 'Agent pracuje',
  'taskboard.card.runSucceeded': 'Wykonanie zakończone powodzeniem',
  'taskboard.card.runFailed': 'Wykonanie nie powiodło się',
  'taskboard.card.scheduled': 'Zaplanowano',
  'taskboard.toast.created': 'Utworzono zadanie',
  'taskboard.toast.moved': 'Zaktualizowano status zadania',
  'taskboard.toast.runStarted': 'Rozpoczęto wykonywanie zadania',
  'taskboard.toast.failed': 'Operacja tablicy zadań nie powiodła się',
  'taskboard.toast.updated': 'Zaktualizowano zadanie',
  'taskboard.toast.deleted': 'Usunięto zadanie',
  'taskboard.dialog.title': 'Utwórz zadanie',
  'taskboard.dialog.editTitle': 'Edytuj zadanie',
  'taskboard.dialog.description': 'Dodaj zadanie projektu. Zadania w Backlogu pozostają ręczne, dopóki nie przeniesiesz ich do Todo.',
  'taskboard.dialog.fields.title': 'Tytuł',
  'taskboard.dialog.fields.titlePlaceholder': 'Co trzeba zrobić?',
  'taskboard.dialog.fields.project': 'Projekt',
  'taskboard.dialog.fields.model': 'Model',
  'taskboard.dialog.fields.agent': 'Agent',
  'taskboard.dialog.fields.goalEnabled': 'Włącz tryb Goal',
  'taskboard.dialog.fields.schedule': 'Harmonogram',
  'taskboard.dialog.fields.date': 'Data',
  'taskboard.dialog.fields.time': 'Godzina',
  'taskboard.dialog.fields.timezone': 'Strefa czasowa',
  'taskboard.dialog.fields.context': 'Przekazanie kontekstu',
  'taskboard.dialog.fields.sourceSession': 'Sesja źródłowa',
  'taskboard.dialog.context.new': 'Rozpocznij nową sesję',
  'taskboard.dialog.context.fork': 'Rozgałęź sesję',
  'taskboard.dialog.context.handoff': 'Utwórz lokalne przekazanie',
  'taskboard.dialog.sourceSessionPlaceholder': 'Szukaj sesji po tytule lub ID',
  'taskboard.dialog.sourceSessionNoResults': 'Brak pasujących sesji.',
  'taskboard.dialog.validation.sourceSessionRequired': 'Wybierz sesję źródłową.',
  'taskboard.dialog.schedule.none': 'Brak harmonogramu',
  'taskboard.dialog.schedule.once': 'Uruchom raz',
  'taskboard.dialog.schedule.daily': 'Codziennie',
  'taskboard.schedule.title': 'Szablony zaplanowanych zadań',
  'taskboard.schedule.description': 'Szablony tworzą zwykłe zadania, gdy nadejdzie ich termin.',
  'taskboard.schedule.once': 'Raz',
  'taskboard.schedule.daily': 'Codziennie',
  'taskboard.dialog.validation.projectRequired': 'Wybierz projekt.',
  'taskboard.dialog.validation.modelRequired': 'Wybierz model.',
  'taskboard.dialog.validation.agentRequired': 'Wybierz agenta.',
  'taskboard.dialog.validation.goalObjectiveRequired': 'Wpisz cel Goal.',
  'taskboard.dialog.fields.description': 'Opis',
  'taskboard.dialog.fields.descriptionPlaceholder': 'Dodaj kontekst i kryteria akceptacji dla agenta.',
  'taskboard.dialog.fields.labels': 'Etykiety',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp, backend, dalsze prace',
  'taskboard.dialog.fields.priority': 'Priorytet',
  'taskboard.dialog.fields.status': 'Status początkowy',
  'taskboard.dialog.actions.cancel': 'Anuluj',
  'taskboard.dialog.actions.create': 'Utwórz zadanie',
  'taskboard.dialog.actions.creating': 'Tworzenie...',
  'taskboard.dialog.actions.save': 'Zapisz zmiany',
  'taskboard.dialog.actions.saving': 'Zapisywanie...',
  'taskboard.project.noResults': 'Brak pasujących projektów.',
  'taskboard.delete.title': 'Usunąć zadanie?',
  'taskboard.delete.description': 'To zadanie nie zostało jeszcze uruchomione i można je trwale usunąć.',
  'taskboard.delete.cancel': 'Anuluj',
  'taskboard.delete.confirm': 'Usuń zadanie',
  ...
  'terminalView.actions.uploadFiles': 'Prześlij pliki do bieżącego katalogu',
  'terminalView.upload.success': 'Przesłane pliki: {count}.',
  'terminalView.upload.conflict': 'Istniejące pliki nie zostały nadpisane: {count}.',
  'terminalView.upload.failed': 'Nieudane przesyłanie plików: {count}.',
  'terminalView.upload.chooseDirectory': 'Wybierz katalog przesyłania',
  'terminalView.upload.chooseDirectoryDescription': 'Wybierz katalog serwera dla plików.',
  'terminalView.upload.currentDirectory': 'Katalog serwera',
  'terminalView.upload.parentDirectory': 'Przejdź do katalogu nadrzędnego',
  'terminalView.upload.selectDirectory': 'Wybierz ten katalog i prześlij',
  'terminalView.upload.directoryLoading': 'Ładowanie katalogów...',
  'terminalView.upload.directoryEmpty': 'Brak podkatalogów',
  'terminalView.upload.directoryLoadFailed': 'Nie udało się załadować tego katalogu.',
  'terminalView.upload.directoryRetry': 'Spróbuj ponownie',
  ...
  'settings.usage.tokenUsage.title': 'Wykorzystanie tokenów',
  'settings.usage.tokenUsage.today': 'Dzisiaj',
  'settings.usage.tokenUsage.thisMonth': 'Ten miesiąc',
  'settings.usage.tokenUsage.total': 'Suma',
  'settings.usage.tokenUsage.previousMonth': 'Poprzedni miesiąc',
  'settings.usage.tokenUsage.nextMonth': 'Następny miesiąc',
  'settings.usage.tokenUsage.noData': 'Brak danych o wykorzystaniu tokenów w tym miesiącu.',
  'settings.usage.tokenUsage.loading': 'Ładowanie wykorzystania tokenów...',
  'settings.usage.tokenUsage.retry': 'Spróbuj ponownie',
  'settings.usage.tokenUsage.timezone': 'Strefa czasowa usługi: {timezone}',
  'settings.usage.tokenUsage.recentDays': 'Ostatnie 14 dni',
  'settings.usage.tokenUsage.date': 'Data',
  'settings.usage.tokenUsage.share': 'Udział',
  'settings.usage.tokenUsage.modelShare': 'Udział: {percent}%',
  'settings.usage.tokenUsage.modelDetails': 'Szczegóły modelu',
  'settings.usage.tokenUsage.modelDetailsForDate': 'Szczegóły modeli dla {date}',
  'settings.usage.tokenUsage.providerModel': 'Dostawca / model',
  'settings.usage.tokenUsage.selectDate': 'Pokaż szczegóły tokenów dla {date}',
  'settings.usage.tokenUsage.noModelDetails': 'Brak szczegółów modelu dla tego dnia.',
  ...
  'chat.sessionMetrics.tokens': 'Zużycie sesji',
  ...
  'chat.sessionMetrics.speed': 'tokenów/s',
