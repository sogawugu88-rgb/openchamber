...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'taskboard.eyebrow': 'Робочий процес проєкту',
  'taskboard.title': 'Дошка завдань',
  'taskboard.description': 'Поставте роботу проєкту в чергу незалежних сесій OpenCode та перевірте результат перед прийняттям.',
  'taskboard.project.placeholder': 'Виберіть проєкт',
  'taskboard.project.all': 'Усі проєкти',
  'taskboard.aggregate.partial': 'Не вдалося завантажити деякі дошки проєктів.',
  'taskboard.actions.new': 'Нове завдання',
  'taskboard.actions.edit': 'Редагувати',
  'taskboard.actions.delete': 'Видалити',
  'taskboard.actions.refresh': 'Оновити',
  'taskboard.actions.retry': 'Повторити',
  'taskboard.actions.openSession': 'Відкрити сесію',
  'taskboard.actions.run': 'Запустити зараз',
  'taskboard.automation.label': 'Автоматичне виконання',
  'taskboard.automation.description': 'Автоматично беруться лише завдання зі статусом Todo.',
  'taskboard.automation.enabled': 'Увімкнено',
  'taskboard.automation.disabled': 'Вимкнено',
  'taskboard.columns.backlog': 'Беклог',
  'taskboard.columns.todo': 'Todo',
  'taskboard.columns.inProgress': 'У роботі',
  'taskboard.columns.inReview': 'На перевірці',
  'taskboard.columns.blocked': 'Заблоковано',
  'taskboard.columns.done': 'Готово',
  'taskboard.status.backlog': 'Беклог',
  'taskboard.status.todo': 'Todo',
  'taskboard.status.in_progress': 'У роботі',
  'taskboard.status.in_review': 'На перевірці',
  'taskboard.status.blocked': 'Заблоковано',
  'taskboard.status.done': 'Готово',
  'taskboard.status.canceled': 'Скасовано',
  'taskboard.priority.none': 'Без пріоритету',
  'taskboard.priority.urgent': 'Терміново',
  'taskboard.priority.high': 'Високий',
  'taskboard.priority.medium': 'Середній',
  'taskboard.priority.low': 'Низький',
  'taskboard.empty.title': 'Завдань ще немає',
  'taskboard.loading': 'Завантаження дошки завдань...',
  'taskboard.empty.description': 'Створіть завдання, перенесіть його до Todo, коли воно готове, і Worker запустить незалежну сесію.',
  'taskboard.empty.column': 'Завдань немає',
  'taskboard.card.blockedBy': 'Очікування залежностей',
  'taskboard.card.running': 'Agent працює',
  'taskboard.card.runSucceeded': 'Виконання успішне',
  'taskboard.card.runFailed': 'Помилка виконання',
  'taskboard.card.scheduled': 'Заплановано',
  'taskboard.toast.created': 'Завдання створено',
  'taskboard.toast.moved': 'Статус завдання оновлено',
  'taskboard.toast.runStarted': 'Виконання завдання розпочато',
  'taskboard.toast.failed': 'Не вдалося виконати дію дошки',
  'taskboard.toast.updated': 'Завдання оновлено',
  'taskboard.toast.deleted': 'Завдання видалено',
  'taskboard.dialog.title': 'Створити завдання',
  'taskboard.dialog.editTitle': 'Редагувати завдання',
  'taskboard.dialog.description': 'Додайте завдання проєкту. Завдання в беклозі залишаються ручними, доки ви не перенесете їх до Todo.',
  'taskboard.dialog.fields.title': 'Назва',
  'taskboard.dialog.fields.titlePlaceholder': 'Що потрібно зробити?',
  'taskboard.dialog.fields.project': 'Проєкт',
  'taskboard.dialog.fields.model': 'Модель',
  'taskboard.dialog.fields.agent': 'Agent',
  'taskboard.dialog.fields.goalEnabled': 'Увімкнути режим Goal',
  'taskboard.dialog.fields.schedule': 'Розклад',
  'taskboard.dialog.fields.date': 'Дата',
  'taskboard.dialog.fields.time': 'Час',
  'taskboard.dialog.fields.timezone': 'Часовий пояс',
  'taskboard.dialog.fields.context': 'Передача контексту',
  'taskboard.dialog.fields.sourceSession': 'Вихідна сесія',
  'taskboard.dialog.context.new': 'Почати нову сесію',
  'taskboard.dialog.context.fork': 'Створити форк сесії',
  'taskboard.dialog.context.handoff': 'Створити локальну передачу',
  'taskboard.dialog.sourceSessionPlaceholder': 'Шукайте сесії за назвою або ID',
  'taskboard.dialog.sourceSessionNoResults': 'Відповідних сесій не знайдено.',
  'taskboard.dialog.validation.sourceSessionRequired': 'Виберіть вихідну сесію.',
  'taskboard.dialog.schedule.none': 'Без розкладу',
  'taskboard.dialog.schedule.once': 'Виконати один раз',
  'taskboard.dialog.schedule.daily': 'Щодня',
  'taskboard.schedule.title': 'Шаблони запланованих завдань',
  'taskboard.schedule.description': 'Ці шаблони створюють звичайні завдання після настання часу.',
  'taskboard.schedule.once': 'Одноразово',
  'taskboard.schedule.daily': 'Щодня',
  'taskboard.dialog.validation.projectRequired': 'Виберіть проєкт.',
  'taskboard.dialog.validation.modelRequired': 'Виберіть модель.',
  'taskboard.dialog.validation.agentRequired': 'Виберіть Agent.',
  'taskboard.dialog.validation.goalObjectiveRequired': 'Введіть ціль Goal.',
  'taskboard.dialog.fields.description': 'Опис',
  'taskboard.dialog.fields.descriptionPlaceholder': 'Додайте контекст і критерії приймання для Agent.',
  'taskboard.dialog.fields.labels': 'Мітки',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp, backend, подальша робота',
  'taskboard.dialog.fields.priority': 'Пріоритет',
  'taskboard.dialog.fields.status': 'Початковий статус',
  'taskboard.dialog.actions.cancel': 'Скасувати',
  'taskboard.dialog.actions.create': 'Створити завдання',
  'taskboard.dialog.actions.creating': 'Створення...',
  'taskboard.dialog.actions.save': 'Зберегти зміни',
  'taskboard.dialog.actions.saving': 'Збереження...',
  'taskboard.project.noResults': 'Відповідних проєктів не знайдено.',
  'taskboard.delete.title': 'Видалити завдання?',
  'taskboard.delete.description': 'Це завдання ще не запускалося, тому його можна видалити назавжди.',
  'taskboard.delete.cancel': 'Скасувати',
  'taskboard.delete.confirm': 'Видалити завдання',
  'terminalView.actions.attachSelection': 'Прикріпити вибраний вивід',
  'terminalView.actions.restart': 'Перезапустити термінал',
  'terminalView.actions.uploadFiles': 'Завантажити файли до поточного каталогу',
  'terminalView.upload.success': 'Завантажено файлів: {count}.',
  'terminalView.upload.conflict': 'Наявні файли не перезаписано: {count}.',
  'terminalView.upload.failed': 'Помилки завантаження: {count}.',
  'terminalView.upload.chooseDirectory': 'Вибрати каталог завантаження',
  'terminalView.upload.chooseDirectoryDescription': 'Виберіть каталог сервера для файлів.',
  'terminalView.upload.currentDirectory': 'Каталог сервера',
  'terminalView.upload.parentDirectory': 'Перейти до батьківського каталогу',
  'terminalView.upload.selectDirectory': 'Вибрати цей каталог і завантажити',
  'terminalView.upload.directoryLoading': 'Завантаження каталогів...',
  'terminalView.upload.directoryEmpty': 'Немає підкаталогів',
  'terminalView.upload.directoryLoadFailed': 'Не вдалося завантажити цей каталог.',
  'terminalView.upload.directoryRetry': 'Повторити',
  ...
  "settings.usage.tokenUsage.title": "Використання токенів",
  "settings.usage.tokenUsage.today": "Сьогодні",
  "settings.usage.tokenUsage.thisMonth": "Цього місяця",
  "settings.usage.tokenUsage.total": "Усього",
  "settings.usage.tokenUsage.previousMonth": "Попередній місяць",
  "settings.usage.tokenUsage.nextMonth": "Наступний місяць",
  "settings.usage.tokenUsage.noData": "За цей місяць немає даних про використання токенів.",
  "settings.usage.tokenUsage.loading": "Завантаження використання токенів...",
  "settings.usage.tokenUsage.retry": "Повторити",
  "settings.usage.tokenUsage.timezone": "Часовий пояс сервісу: {timezone}",
  "settings.usage.tokenUsage.recentDays": "Останні 14 днів",
  "settings.usage.tokenUsage.date": "Дата",
  "settings.usage.tokenUsage.share": "Частка",
  "settings.usage.tokenUsage.modelShare": "Частка: {percent}%",
  "settings.usage.tokenUsage.modelDetails": "Деталі моделі",
  "settings.usage.tokenUsage.modelDetailsForDate": "Деталі моделей для {date}",
  "settings.usage.tokenUsage.providerModel": "Постачальник / модель",
  "settings.usage.tokenUsage.selectDate": "Показати деталі токенів для {date}",
  "settings.usage.tokenUsage.noModelDetails": "Для цієї дати немає деталей моделі.",
  ...
  "chat.sessionMetrics.tokens": "Використання сеансу",
  "chat.sessionMetrics.turns": "Раунди",
  "chat.sessionMetrics.steps": "Кроки",
  "chat.sessionMetrics.cacheTokens": "Кеш",
  "chat.sessionMetrics.llm": "LLM",
  "chat.sessionMetrics.tools": "Інструменти",
  "chat.sessionMetrics.ttft": "TTFT",
  "chat.sessionMetrics.cache": "Кеш",
  "chat.sessionMetrics.speed": "токенів/с",
