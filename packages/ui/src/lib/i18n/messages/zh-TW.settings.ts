...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.autoContinue.sectionTitle': '自動繼續',
  'settings.openchamber.visual.autoContinue.description': '當提供者速率限制導致一個回合結束時，OpenChamber 可以在同一個工作階段中傳送新的合成繼續訊息。僅適用於一般對話，不適用於目標模式。',
  'settings.openchamber.visual.autoContinue.enabled': '限流後自動繼續',
  'settings.openchamber.visual.autoContinue.enabledAria': '提供者限流後自動繼續一般對話',
  'settings.openchamber.visual.autoContinue.maxRetries': '最多傳送的繼續訊息數',
  'settings.openchamber.visual.autoContinue.maxRetriesInfo': '對於一次限流失敗，OpenChamber 最多傳送你設定數量的新繼續訊息，預設值為 5。設為 0 可停用自動恢復。',
  'settings.openchamber.visual.autoContinue.maxRetriesAria': '自動繼續訊息的最大數量',
  'settings.openchamber.visual.autoContinue.prompt': '繼續訊息',
  'settings.openchamber.visual.autoContinue.promptInfo': '限流失敗後，這段文字會以合成使用者訊息傳送。留白會使用內建訊息。',
  'settings.openchamber.visual.autoContinue.promptPlaceholder': '留白以使用預設繼續訊息',
  'settings.openchamber.visual.autoContinue.promptAria': '提供者限流後傳送的繼續訊息',
  'settings.openchamber.visual.goal.auditFailureLimitLabel': '阻塞前允許的稽核失敗次數',
  'settings.openchamber.visual.goal.auditFailureLimitAria': '阻塞前允許的連續 Goal 稽核失敗次數',
  'settings.openchamber.visual.goal.auditFailureLimitDescription': '設定 Goal 模式在稽核無法使用或連續觸發限流後，允許繼續執行的次數。達到此次數後會標記為阻塞。範圍：1 到 20。',
  'settings.openchamber.visual.codeServer.sectionTitle': '雲端 code-server',
  'settings.openchamber.visual.codeServer.label': '基礎網址',
  'settings.openchamber.visual.codeServer.aria': '雲端 code-server 基礎網址',
  'settings.openchamber.visual.codeServer.description': '設定雲端 code-server 的基礎網址。開啟專案時，目前專案目錄會自動加入為 folder 參數。',
  ...
  'settings.openchamber.visual.field.showSessionTokenDetailsAria': '在 Composer 中顯示工作階段 Token 詳細資料',
  'settings.openchamber.visual.field.showSessionTokenDetails': '顯示工作階段 Token 詳細資料',
  'settings.openchamber.visual.field.showSessionTokenDetailsInfo': '回應後在 Composer 下方顯示 Token 與時間指標。',
