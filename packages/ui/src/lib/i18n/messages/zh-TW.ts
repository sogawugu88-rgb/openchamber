...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'taskboard.eyebrow': '專案工作流程',
  'taskboard.title': '任務看板',
  'taskboard.description': '將專案工作交給獨立的 OpenCode 工作階段執行，並在接受前檢查結果。',
  'taskboard.project.placeholder': '選擇專案',
  'taskboard.project.all': '所有專案',
  'taskboard.aggregate.partial': '部分專案的任務看板載入失敗。',
  'taskboard.actions.new': '新增任務',
  'taskboard.actions.edit': '編輯',
  'taskboard.actions.delete': '刪除',
  'taskboard.actions.refresh': '重新整理',
  'taskboard.actions.retry': '重試',
  'taskboard.actions.openSession': '開啟工作階段',
  'taskboard.actions.run': '立即執行',
  'taskboard.automation.label': '自動執行',
  'taskboard.automation.description': '只有 Todo 狀態的任務會被自動領取。',
  'taskboard.automation.enabled': '已啟用',
  'taskboard.automation.disabled': '已停用',
  'taskboard.columns.backlog': '待規劃',
  'taskboard.columns.todo': '待處理',
  'taskboard.columns.inProgress': '進行中',
  'taskboard.columns.inReview': '待審查',
  'taskboard.columns.blocked': '已封鎖',
  'taskboard.columns.done': '已完成',
  'taskboard.status.backlog': '待規劃',
  'taskboard.status.todo': '待處理',
  'taskboard.status.in_progress': '進行中',
  'taskboard.status.in_review': '待審查',
  'taskboard.status.blocked': '已封鎖',
  'taskboard.status.done': '已完成',
  'taskboard.status.canceled': '已取消',
  'taskboard.priority.none': '無優先順序',
  'taskboard.priority.urgent': '緊急',
  'taskboard.priority.high': '高',
  'taskboard.priority.medium': '中',
  'taskboard.priority.low': '低',
  'taskboard.empty.title': '尚無任務',
  'taskboard.loading': '正在載入任務看板...',
  'taskboard.empty.description': '建立任務，準備好後移至待處理，Worker 會啟動獨立工作階段執行。',
  'taskboard.empty.column': '沒有任務',
  'taskboard.card.blockedBy': '等待相依任務完成',
  'taskboard.card.running': 'Agent 正在工作',
  'taskboard.card.runSucceeded': '執行成功',
  'taskboard.card.runFailed': '執行失敗',
  'taskboard.card.scheduled': '已排程',
  'taskboard.toast.created': '任務已建立',
  'taskboard.toast.moved': '任務狀態已更新',
  'taskboard.toast.runStarted': '任務已開始執行',
  'taskboard.toast.failed': '看板操作失敗',
  'taskboard.toast.updated': '任務已更新',
  'taskboard.toast.deleted': '任務已刪除',
  'taskboard.dialog.title': '建立任務',
  'taskboard.dialog.editTitle': '編輯任務',
  'taskboard.dialog.description': '新增專案任務。任務移至待處理前不會自動執行。',
  'taskboard.dialog.fields.title': '標題',
  'taskboard.dialog.fields.titlePlaceholder': '需要完成什麼？',
  'taskboard.dialog.fields.project': '專案',
  'taskboard.dialog.fields.model': '模型',
  'taskboard.dialog.fields.agent': 'Agent',
  'taskboard.dialog.fields.goalEnabled': '啟用目標模式',
  'taskboard.dialog.fields.schedule': '排程',
  'taskboard.dialog.fields.date': '日期',
  'taskboard.dialog.fields.time': '時間',
  'taskboard.dialog.fields.timezone': '時區',
  'taskboard.dialog.fields.context': '上下文承接',
  'taskboard.dialog.fields.sourceSession': '來源工作階段',
  'taskboard.dialog.context.new': '啟動新工作階段',
  'taskboard.dialog.context.fork': 'Fork 工作階段',
  'taskboard.dialog.context.handoff': '寫入本機交接文件',
  'taskboard.dialog.sourceSessionPlaceholder': '依標題或 ID 搜尋工作階段',
  'taskboard.dialog.sourceSessionNoResults': '沒有符合的工作階段。',
  'taskboard.dialog.validation.sourceSessionRequired': '請選擇來源工作階段。',
  'taskboard.dialog.schedule.none': '不設定排程',
  'taskboard.dialog.schedule.once': '執行一次',
  'taskboard.dialog.schedule.daily': '每天',
  'taskboard.schedule.title': '排程任務範本',
  'taskboard.schedule.description': '到達排程時間後，這些範本會建立一般任務。',
  'taskboard.schedule.once': '一次性',
  'taskboard.schedule.daily': '每天',
  'taskboard.dialog.validation.projectRequired': '請選擇專案。',
  'taskboard.dialog.validation.modelRequired': '請選擇模型。',
  'taskboard.dialog.validation.agentRequired': '請選擇 Agent。',
  'taskboard.dialog.validation.goalObjectiveRequired': '請輸入目標內容。',
  'taskboard.dialog.fields.description': '描述',
  'taskboard.dialog.fields.descriptionPlaceholder': '補充 Agent 需要的內容和驗收條件。',
  'taskboard.dialog.fields.labels': '標籤',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp、後端、後續處理',
  'taskboard.dialog.fields.priority': '優先順序',
  'taskboard.dialog.fields.status': '初始狀態',
  'taskboard.dialog.actions.cancel': '取消',
  'taskboard.dialog.actions.create': '建立任務',
  'taskboard.dialog.actions.creating': '建立中...',
  'taskboard.dialog.actions.save': '儲存變更',
  'taskboard.dialog.actions.saving': '儲存中...',
  'taskboard.project.noResults': '沒有符合的專案。',
  'taskboard.delete.title': '刪除任務？',
  'taskboard.delete.description': '此任務尚未啟動，可以永久刪除。',
  'taskboard.delete.cancel': '取消',
  'taskboard.delete.confirm': '刪除任務',
  'terminalView.actions.attachSelection': '附加所選輸出',
  'terminalView.actions.restart': '重新啟動終端',
  'terminalView.actions.uploadFiles': '將檔案上傳到目前目錄',
  'terminalView.upload.success': '已上傳檔案：{count}。',
  'terminalView.upload.conflict': '因已存在而未覆蓋的檔案：{count}。',
  'terminalView.upload.failed': '上傳失敗的檔案：{count}。',
  'terminalView.upload.chooseDirectory': '選擇上傳目錄',
  'terminalView.upload.chooseDirectoryDescription': '選擇存放檔案的伺服器目錄。',
  'terminalView.upload.currentDirectory': '伺服器目錄',
  'terminalView.upload.parentDirectory': '返回上層目錄',
  'terminalView.upload.selectDirectory': '選擇此目錄並上傳',
  'terminalView.upload.directoryLoading': '正在載入目錄...',
  'terminalView.upload.directoryEmpty': '沒有子目錄',
  'terminalView.upload.directoryLoadFailed': '無法載入此目錄。',
  'terminalView.upload.directoryRetry': '重試',
  ...
  'settings.usage.tokenUsage.title': '權杖用量',
  'settings.usage.tokenUsage.today': '今天',
  'settings.usage.tokenUsage.thisMonth': '本月',
  'settings.usage.tokenUsage.total': '總計',
  'settings.usage.tokenUsage.previousMonth': '上個月',
  'settings.usage.tokenUsage.nextMonth': '下個月',
  'settings.usage.tokenUsage.noData': '本月沒有權杖用量資料。',
  'settings.usage.tokenUsage.loading': '正在載入權杖用量...',
  'settings.usage.tokenUsage.retry': '重試',
  'settings.usage.tokenUsage.timezone': '服務時區：{timezone}',
  'settings.usage.tokenUsage.recentDays': '最近 14 天',
  'settings.usage.tokenUsage.date': '日期',
  'settings.usage.tokenUsage.share': '比例',
  'settings.usage.tokenUsage.modelShare': '比例：{percent}%',
  'settings.usage.tokenUsage.modelDetails': '模型詳細資料',
  'settings.usage.tokenUsage.modelDetailsForDate': '{date} 的模型詳細資料',
  'settings.usage.tokenUsage.providerModel': '提供者 / 模型',
  'settings.usage.tokenUsage.selectDate': '顯示 {date} 的 Token 詳細資料',
  'settings.usage.tokenUsage.noModelDetails': '這一天沒有模型詳細資料。',
  ...
  'chat.sessionMetrics.tokens': '工作階段消耗',
  'chat.sessionMetrics.turns': '回合',
  'chat.sessionMetrics.steps': '步驟',
  'chat.sessionMetrics.cacheTokens': '快取',
  'chat.sessionMetrics.llm': 'LLM',
  'chat.sessionMetrics.tools': '工具',
  'chat.sessionMetrics.ttft': 'TTFT',
  'chat.sessionMetrics.cache': '快取',
