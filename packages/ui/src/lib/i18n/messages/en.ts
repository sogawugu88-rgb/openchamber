...
export const dict = {
  ...settingsDict,
  'taskboard.eyebrow': 'Project workflow',
  'taskboard.title': 'Taskboard',
  'taskboard.description': 'Queue project work for independent OpenCode sessions and review the result before accepting it.',
  'taskboard.project.placeholder': 'Choose a project',
  'taskboard.project.all': 'All projects',
  'taskboard.aggregate.partial': 'Some project boards could not be loaded.',
  'taskboard.actions.new': 'New task',
  'taskboard.actions.edit': 'Edit',
  'taskboard.actions.delete': 'Delete',
  'taskboard.actions.refresh': 'Refresh',
  'taskboard.actions.retry': 'Retry',
  'taskboard.actions.openSession': 'Open session',
  'taskboard.actions.run': 'Run now',
  'taskboard.automation.label': 'Automatic execution',
  'taskboard.automation.description': 'Only tasks in Todo are picked up.',
  'taskboard.automation.enabled': 'Enabled',
  'taskboard.automation.disabled': 'Disabled',
  'taskboard.columns.backlog': 'Backlog',
  'taskboard.columns.todo': 'Todo',
  'taskboard.columns.inProgress': 'In progress',
  'taskboard.columns.inReview': 'In review',
  'taskboard.columns.blocked': 'Blocked',
  'taskboard.columns.done': 'Done',
  'taskboard.status.backlog': 'Backlog',
  'taskboard.status.todo': 'Todo',
  'taskboard.status.in_progress': 'In progress',
  'taskboard.status.in_review': 'In review',
  'taskboard.status.blocked': 'Blocked',
  'taskboard.status.done': 'Done',
  'taskboard.status.canceled': 'Canceled',
  ...
  'taskboard.empty.title': 'No tasks yet',
  'taskboard.loading': 'Loading taskboard...',
  'taskboard.empty.description': 'Create a task, move it to Todo when it is ready, and let the worker start an independent session.',
  'taskboard.empty.column': 'No tasks',
  'taskboard.card.blockedBy': 'Waiting for dependencies',
  'taskboard.card.running': 'Agent is working',
  'taskboard.card.runSucceeded': 'Run succeeded',
  'taskboard.card.runFailed': 'Run failed',
  'taskboard.card.scheduled': 'Scheduled',
  'taskboard.toast.created': 'Task created',
  'taskboard.toast.moved': 'Task status updated',
  'taskboard.toast.runStarted': 'Task run started',
  'taskboard.toast.failed': 'Taskboard action failed',
  'taskboard.toast.updated': 'Task updated',
  'taskboard.toast.deleted': 'Task deleted',
  'taskboard.dialog.title': 'Create task',
  'taskboard.dialog.editTitle': 'Edit task',
  'taskboard.dialog.description': 'Add a project task. Backlog tasks stay manual until you move them to Todo.',
  'taskboard.dialog.fields.title': 'Title',
  'taskboard.dialog.fields.titlePlaceholder': 'What needs to be done?',
  'taskboard.dialog.fields.project': 'Project',
  'taskboard.dialog.fields.model': 'Model',
  'taskboard.dialog.fields.agent': 'Agent',
  'taskboard.dialog.fields.goalEnabled': 'Enable Goal mode',
  'taskboard.dialog.fields.schedule': 'Schedule',
  'taskboard.dialog.fields.date': 'Date',
  'taskboard.dialog.fields.time': 'Time',
  'taskboard.dialog.fields.timezone': 'Timezone',
  'taskboard.dialog.fields.context': 'Context handoff',
  'taskboard.dialog.fields.sourceSession': 'Source session',
  'taskboard.dialog.context.new': 'Start a new session',
  'taskboard.dialog.context.fork': 'Fork a session',
  'taskboard.dialog.context.handoff': 'Write a local handoff',
  'taskboard.dialog.sourceSessionPlaceholder': 'Search sessions by title or ID',
  'taskboard.dialog.sourceSessionNoResults': 'No matching sessions.',
  'taskboard.dialog.validation.sourceSessionRequired': 'Choose a source session.',
  'taskboard.dialog.schedule.none': 'No schedule',
  'taskboard.dialog.schedule.once': 'Run once',
  'taskboard.dialog.schedule.daily': 'Every day',
  'taskboard.schedule.title': 'Scheduled task templates',
  'taskboard.schedule.description': 'These templates create ordinary tasks when their schedule is due.',
  'taskboard.schedule.once': 'Once',
  'taskboard.schedule.daily': 'Daily',
  'taskboard.dialog.validation.projectRequired': 'Choose a project.',
  'taskboard.dialog.validation.modelRequired': 'Choose a model.',
  'taskboard.dialog.validation.agentRequired': 'Choose an Agent.',
  'taskboard.dialog.validation.goalObjectiveRequired': 'Enter a Goal objective.',
  'taskboard.dialog.fields.description': 'Description',
  'taskboard.dialog.fields.descriptionPlaceholder': 'Add context and acceptance details for the agent.',
  'taskboard.dialog.fields.labels': 'Labels',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp, backend, follow-up',
  'taskboard.dialog.fields.priority': 'Priority',
  'taskboard.dialog.fields.status': 'Initial status',
  'taskboard.dialog.actions.cancel': 'Cancel',
  'taskboard.dialog.actions.create': 'Create task',
  'taskboard.dialog.actions.creating': 'Creating...',
  'taskboard.dialog.actions.save': 'Save changes',
  'taskboard.dialog.actions.saving': 'Saving...',
  'taskboard.project.noResults': 'No matching projects.',
  'taskboard.delete.title': 'Delete task?',
  'taskboard.delete.description': 'This task has not started and can be deleted permanently.',
  'taskboard.delete.cancel': 'Cancel',
  'taskboard.delete.confirm': 'Delete task',
  'terminalView.actions.attachSelection': 'Attach selected output',
  'terminalView.actions.restart': 'Restart terminal',
  'terminalView.actions.uploadFiles': 'Upload files to the current directory',
  'terminalView.upload.success': 'Uploaded files: {count}.',
  'terminalView.upload.conflict': 'Existing files not overwritten: {count}.',
  'terminalView.upload.failed': 'Upload failures: {count}.',
  'terminalView.upload.chooseDirectory': 'Choose upload directory',
  'terminalView.upload.chooseDirectoryDescription': 'Select a server directory for the files.',
  'terminalView.upload.currentDirectory': 'Server directory',
  'terminalView.upload.parentDirectory': 'Go to parent directory',
  'terminalView.upload.selectDirectory': 'Choose this directory and upload',
  'terminalView.upload.directoryLoading': 'Loading directories...',
  'terminalView.upload.directoryEmpty': 'No subdirectories',
  'terminalView.upload.directoryLoadFailed': 'Could not load this directory.',
  'terminalView.upload.directoryRetry': 'Retry',
  ...
  'settings.usage.tokenUsage.title': 'Token usage',
  'settings.usage.tokenUsage.today': 'Today',
  'settings.usage.tokenUsage.thisMonth': 'This month',
  'settings.usage.tokenUsage.total': 'Total',
  'settings.usage.tokenUsage.previousMonth': 'Previous month',
  'settings.usage.tokenUsage.nextMonth': 'Next month',
  'settings.usage.tokenUsage.noData': 'No token usage data for this month.',
  'settings.usage.tokenUsage.loading': 'Loading token usage...',
  'settings.usage.tokenUsage.retry': 'Retry',
  'settings.usage.tokenUsage.timezone': 'Service timezone: {timezone}',
  'settings.usage.tokenUsage.recentDays': 'Recent 14 days',
  'settings.usage.tokenUsage.date': 'Date',
  'settings.usage.tokenUsage.share': 'Share',
  'settings.usage.tokenUsage.modelShare': 'Share: {percent}%',
  'settings.usage.tokenUsage.modelDetails': 'Model details',
  'settings.usage.tokenUsage.modelDetailsForDate': 'Model details for {date}',
  'settings.usage.tokenUsage.providerModel': 'Provider / model',
  'settings.usage.tokenUsage.selectDate': 'Show token details for {date}',
  'settings.usage.tokenUsage.noModelDetails': 'No model details for this date.',
  ...
  'chat.sessionMetrics.tokens': 'Session usage',
  'chat.sessionMetrics.turns': 'Turns',
  'chat.sessionMetrics.steps': 'Steps',
  'chat.sessionMetrics.cacheTokens': 'Cache',
  'chat.sessionMetrics.llm': 'LLM',
  'chat.sessionMetrics.tools': 'Tools',
