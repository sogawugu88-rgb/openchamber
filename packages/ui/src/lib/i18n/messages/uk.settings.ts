...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.autoContinue.sectionTitle": "Автоматичне продовження",
  "settings.openchamber.visual.autoContinue.description": "Коли ліміт провайдера завершує хід, OpenChamber може надіслати нове синтетичне повідомлення для продовження в тій самій сесії. Це стосується лише звичайних розмов, а не режиму цілі.",
  "settings.openchamber.visual.autoContinue.enabled": "Автоматично продовжувати після лімітів провайдера",
  "settings.openchamber.visual.autoContinue.enabledAria": "Автоматично продовжувати звичайні розмови після ліміту провайдера",
  "settings.openchamber.visual.autoContinue.maxRetries": "Максимальна кількість повідомлень для продовження",
  "settings.openchamber.visual.autoContinue.maxRetriesInfo": "Для одного ходу з обмеженням OpenChamber надсилає налаштовану кількість нових повідомлень для продовження. Типове значення — 5; встановіть 0, щоб вимкнути автоматичне відновлення.",
  "settings.openchamber.visual.autoContinue.maxRetriesAria": "Максимальна кількість автоматичних повідомлень для продовження",
  "settings.openchamber.visual.autoContinue.prompt": "Повідомлення для продовження",
  "settings.openchamber.visual.autoContinue.promptInfo": "Це повідомлення надсилається як синтетичне повідомлення користувача після помилки ліміту. Залиште поле порожнім, щоб використати вбудоване повідомлення.",
  "settings.openchamber.visual.autoContinue.promptPlaceholder": "Залиште порожнім, щоб використати стандартне повідомлення для продовження",
  "settings.openchamber.visual.autoContinue.promptAria": "Повідомлення для продовження після ліміту провайдера",
  "settings.openchamber.visual.goal.auditFailureLimitLabel": "Помилки аудиту до блокування",
  "settings.openchamber.visual.goal.auditFailureLimitAria": "Кількість послідовних помилок аудиту Goal, дозволених до блокування",
  "settings.openchamber.visual.goal.auditFailureLimitDescription": "Визначає, скільки послідовних недоступних або обмежених лімітом викликів аудиту Goal Mode дозволено до блокування. Діапазон: від 1 до 20.",
  "settings.openchamber.visual.codeServer.sectionTitle": "Хмарний code-server",
  "settings.openchamber.visual.codeServer.label": "Базова URL-адреса",
  "settings.openchamber.visual.codeServer.aria": "Базова URL-адреса хмарного code-server",
  "settings.openchamber.visual.codeServer.description": "Укажіть базову URL-адресу хмарного code-server. Під час відкриття поточний каталог проєкту буде додано як параметр folder.",
  ...
  "settings.openchamber.visual.field.showSessionTokenDetailsAria": "Показувати деталі токенів сесії в Composer",
  "settings.openchamber.visual.field.showSessionTokenDetails": "Показувати деталі токенів сесії",
  "settings.openchamber.visual.field.showSessionTokenDetailsInfo": "Показувати показники токенів і часу під Composer після відповіді.",
