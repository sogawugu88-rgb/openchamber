...
export const settingsDict = {
  ...
  'settings.openchamber.visual.autoContinue.sectionTitle': 'Automatic continuation',
  'settings.openchamber.visual.autoContinue.description': 'When a provider rate limit ends a turn, OpenChamber can send a new synthetic continuation message in the same session. This applies only to ordinary conversations, not Goal Mode.',
  'settings.openchamber.visual.autoContinue.enabled': 'Automatically continue after rate limits',
  'settings.openchamber.visual.autoContinue.enabledAria': 'Automatically continue ordinary conversations after a provider rate limit',
  'settings.openchamber.visual.autoContinue.maxRetries': 'Maximum continuation messages',
  'settings.openchamber.visual.autoContinue.maxRetriesInfo': 'OpenChamber sends up to the configured number of new continuation messages for one rate-limited turn. The default is 5; set 0 to disable recovery messages.',
  'settings.openchamber.visual.autoContinue.maxRetriesAria': 'Maximum automatic continuation messages',
  'settings.openchamber.visual.autoContinue.prompt': 'Continuation message',
  'settings.openchamber.visual.autoContinue.promptInfo': 'This message is sent as a synthetic user message after a rate-limit failure. Leave it blank to use the built-in message.',
  'settings.openchamber.visual.autoContinue.promptPlaceholder': 'Leave blank to use the default continuation message',
  'settings.openchamber.visual.autoContinue.promptAria': 'Message sent to continue after a provider rate limit',
  'settings.openchamber.visual.goal.auditFailureLimitLabel': 'Audit failures before blocking',
  'settings.openchamber.visual.goal.auditFailureLimitAria': 'Number of consecutive Goal audit failures tolerated before blocking',
  'settings.openchamber.visual.goal.auditFailureLimitDescription': 'Controls how many consecutive unavailable or rate-limited audit calls Goal Mode tolerates before it becomes blocked. Range: 1 to 20.',
  'settings.openchamber.visual.codeServer.sectionTitle': 'Cloud code-server',
  'settings.openchamber.visual.codeServer.label': 'Base URL',
  'settings.openchamber.visual.codeServer.aria': 'Cloud code-server base URL',
  'settings.openchamber.visual.codeServer.description': 'Set the cloud code-server base URL. The current project directory is added as the folder parameter when you open it.',
  ...
  'settings.openchamber.visual.field.showSessionTokenDetailsAria': 'Show session token details in the Composer',
  'settings.openchamber.visual.field.showSessionTokenDetails': 'Show session token details',
  'settings.openchamber.visual.field.showSessionTokenDetailsInfo': 'Show the token and timing metrics row below the Composer after a response.',
