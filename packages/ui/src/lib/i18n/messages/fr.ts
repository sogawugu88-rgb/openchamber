...
export const dict = {
  ...settingsDict,
  'taskboard.eyebrow': 'Flux du projet',
  'taskboard.title': 'Tableau des tâches',
  'taskboard.description': 'Mettez les tâches du projet en file d’attente pour des sessions OpenCode indépendantes et vérifiez le résultat avant de l’accepter.',
  'taskboard.project.placeholder': 'Choisir un projet',
  'taskboard.project.all': 'Tous les projets',
  'taskboard.aggregate.partial': 'Certains tableaux de projet n’ont pas pu être chargés.',
  'taskboard.actions.new': 'Nouvelle tâche',
  'taskboard.actions.edit': 'Modifier',
  'taskboard.actions.delete': 'Supprimer',
  'taskboard.actions.refresh': 'Actualiser',
  'taskboard.actions.retry': 'Réessayer',
  'taskboard.actions.openSession': 'Ouvrir la session',
  'taskboard.actions.run': 'Exécuter maintenant',
  'taskboard.automation.label': 'Exécution automatique',
  'taskboard.automation.description': 'Seules les tâches dans Todo sont prises en charge.',
  'taskboard.automation.enabled': 'Activée',
  'taskboard.automation.disabled': 'Désactivée',
  'taskboard.columns.backlog': 'Backlog',
  'taskboard.columns.todo': 'Todo',
  'taskboard.columns.inProgress': 'En cours',
  'taskboard.columns.inReview': 'En révision',
  'taskboard.columns.blocked': 'Bloquée',
  'taskboard.columns.done': 'Terminée',
  'taskboard.status.backlog': 'Backlog',
  'taskboard.status.todo': 'Todo',
  'taskboard.status.in_progress': 'En cours',
  'taskboard.status.in_review': 'En révision',
  'taskboard.status.blocked': 'Bloquée',
  'taskboard.status.done': 'Terminée',
  'taskboard.status.canceled': 'Annulée',
  'taskboard.priority.none': 'Aucune priorité',
  'taskboard.priority.urgent': 'Urgente',
  'taskboard.priority.high': 'Élevée',
  'taskboard.priority.medium': 'Moyenne',
  'taskboard.priority.low': 'Faible',
  'taskboard.empty.title': 'Aucune tâche pour le moment',
  'taskboard.loading': 'Chargement du tableau des tâches...',
  'taskboard.empty.description': 'Créez une tâche, déplacez-la dans Todo lorsqu’elle est prête et laissez le worker démarrer une session indépendante.',
  'taskboard.empty.column': 'Aucune tâche',
  'taskboard.card.blockedBy': 'En attente des dépendances',
  'taskboard.card.running': 'L’agent travaille',
  'taskboard.card.runSucceeded': 'Exécution réussie',
  'taskboard.card.runFailed': 'Échec de l’exécution',
  'taskboard.card.scheduled': 'Planifiée',
  'taskboard.toast.created': 'Tâche créée',
  'taskboard.toast.moved': 'Statut de la tâche mis à jour',
  'taskboard.toast.runStarted': 'Exécution de la tâche démarrée',
  'taskboard.toast.failed': 'Échec de l’action du tableau',
  'taskboard.toast.updated': 'Tâche mise à jour',
  'taskboard.toast.deleted': 'Tâche supprimée',
  'taskboard.dialog.title': 'Créer une tâche',
  'taskboard.dialog.editTitle': 'Modifier la tâche',
  'taskboard.dialog.description': 'Ajoutez une tâche au projet. Les tâches du Backlog restent manuelles jusqu’à leur déplacement vers Todo.',
  'taskboard.dialog.fields.title': 'Titre',
  'taskboard.dialog.fields.titlePlaceholder': 'Que faut-il faire ?',
  'taskboard.dialog.fields.project': 'Projet',
  'taskboard.dialog.fields.model': 'Modèle',
  'taskboard.dialog.fields.agent': 'Agent',
  'taskboard.dialog.fields.goalEnabled': 'Activer le mode Goal',
  'taskboard.dialog.fields.schedule': 'Planification',
  'taskboard.dialog.fields.date': 'Date',
  'taskboard.dialog.fields.time': 'Heure',
  'taskboard.dialog.fields.timezone': 'Fuseau horaire',
  'taskboard.dialog.fields.context': 'Transmission du contexte',
  'taskboard.dialog.fields.sourceSession': 'Session source',
  'taskboard.dialog.context.new': 'Démarrer une nouvelle session',
  'taskboard.dialog.context.fork': 'Forker une session',
  'taskboard.dialog.context.handoff': 'Écrire une transmission locale',
  'taskboard.dialog.sourceSessionPlaceholder': 'Rechercher par titre ou ID',
  'taskboard.dialog.sourceSessionNoResults': 'Aucune session correspondante.',
  'taskboard.dialog.validation.sourceSessionRequired': 'Choisissez une session source.',
  'taskboard.dialog.schedule.none': 'Aucune planification',
  'taskboard.dialog.schedule.once': 'Exécuter une fois',
  'taskboard.dialog.schedule.daily': 'Chaque jour',
  'taskboard.schedule.title': 'Modèles de tâches planifiées',
  'taskboard.schedule.description': 'Ces modèles créent des tâches normales à échéance.',
  'taskboard.schedule.once': 'Une fois',
  'taskboard.schedule.daily': 'Quotidienne',
  'taskboard.dialog.validation.projectRequired': 'Choisissez un projet.',
  'taskboard.dialog.validation.modelRequired': 'Choisissez un modèle.',
  'taskboard.dialog.validation.agentRequired': 'Choisissez un agent.',
  'taskboard.dialog.validation.goalObjectiveRequired': 'Saisissez l’objectif du Goal.',
  'taskboard.dialog.fields.description': 'Description',
  'taskboard.dialog.fields.descriptionPlaceholder': 'Ajoutez le contexte et les critères d’acceptation pour l’agent.',
  'taskboard.dialog.fields.labels': 'Étiquettes',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp, backend, suivi',
  'taskboard.dialog.fields.priority': 'Priorité',
  'taskboard.dialog.fields.status': 'Statut initial',
  'taskboard.dialog.actions.cancel': 'Annuler',
  'taskboard.dialog.actions.create': 'Créer la tâche',
  'taskboard.dialog.actions.creating': 'Création...',
  'taskboard.dialog.actions.save': 'Enregistrer les modifications',
  'taskboard.dialog.actions.saving': 'Enregistrement...',
  'taskboard.project.noResults': 'Aucun projet correspondant.',
  'taskboard.delete.title': 'Supprimer la tâche ?',
  'taskboard.delete.description': 'Cette tâche n’a pas commencé et peut être supprimée définitivement.',
  'taskboard.delete.cancel': 'Annuler',
  'taskboard.delete.confirm': 'Supprimer la tâche',
  'terminalView.actions.attachSelection': 'Joindre la sortie sélectionnée',
  'terminalView.actions.restart': 'Redémarrer le terminal',
  'terminalView.actions.uploadFiles': 'Importer des fichiers dans le répertoire actuel',
  'terminalView.upload.success': 'Fichiers importés : {count}.',
  'terminalView.upload.conflict': 'Fichiers existants non remplacés : {count}.',
  'terminalView.upload.failed': 'Échecs d’importation : {count}.',
  'terminalView.upload.chooseDirectory': 'Choisir le répertoire d’importation',
  'terminalView.upload.chooseDirectoryDescription': 'Sélectionnez un répertoire du serveur pour les fichiers.',
  'terminalView.upload.currentDirectory': 'Répertoire du serveur',
  'terminalView.upload.parentDirectory': 'Accéder au répertoire parent',
  'terminalView.upload.selectDirectory': 'Choisir ce répertoire et importer',
  'terminalView.upload.directoryLoading': 'Chargement des répertoires...',
  'terminalView.upload.directoryEmpty': 'Aucun sous-répertoire',
  'terminalView.upload.directoryLoadFailed': 'Impossible de charger ce répertoire.',
  'terminalView.upload.directoryRetry': 'Réessayer',
  ...
  'settings.usage.tokenUsage.title': 'Utilisation des tokens',
  'settings.usage.tokenUsage.today': 'Aujourd’hui',
  'settings.usage.tokenUsage.thisMonth': 'Ce mois-ci',
  'settings.usage.tokenUsage.total': 'Total',
  'settings.usage.tokenUsage.previousMonth': 'Mois précédent',
  'settings.usage.tokenUsage.nextMonth': 'Mois suivant',
  'settings.usage.tokenUsage.noData': 'Aucune donnée d’utilisation des tokens pour ce mois.',
  'settings.usage.tokenUsage.loading': 'Chargement de l’utilisation des tokens...',
  'settings.usage.tokenUsage.retry': 'Réessayer',
  'settings.usage.tokenUsage.timezone': 'Fuseau horaire du service : {timezone}',
  'settings.usage.tokenUsage.recentDays': '14 derniers jours',
  'settings.usage.tokenUsage.date': 'Date',
  'settings.usage.tokenUsage.share': 'Part',
  'settings.usage.tokenUsage.modelShare': 'Part : {percent} %',
  'settings.usage.tokenUsage.modelDetails': 'Détails des modèles',
  'settings.usage.tokenUsage.modelDetailsForDate': 'Détails des modèles pour le {date}',
  'settings.usage.tokenUsage.providerModel': 'Fournisseur / modèle',
  'settings.usage.tokenUsage.selectDate': 'Afficher les détails des tokens pour le {date}',
  'settings.usage.tokenUsage.noModelDetails': 'Aucun détail de modèle pour cette date.',
  ...
  'chat.sessionMetrics.tokens': 'Utilisation de la session',
