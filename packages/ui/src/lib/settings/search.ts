...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  {
    id: 'chat.session-auto-continue',
    page: 'chat',
    titleKey: 'settings.openchamber.visual.autoContinue.enabled',
    descriptionKey: 'settings.openchamber.visual.autoContinue.description',
    keywords: ['rate limit', 'retry', 'continue', 'resend', '429'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'chat.session-auto-continue-max-retries',
    page: 'chat',
    titleKey: 'settings.openchamber.visual.autoContinue.maxRetries',
    descriptionKey: 'settings.openchamber.visual.autoContinue.maxRetriesInfo',
    keywords: ['rate limit', 'retry', 'attempts', 'recovery'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'chat.session-auto-continue-prompt',
    page: 'chat',
    titleKey: 'settings.openchamber.visual.autoContinue.prompt',
    descriptionKey: 'settings.openchamber.visual.autoContinue.promptInfo',
    keywords: ['rate limit', 'retry', 'continuation', 'message', 'prompt'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
