...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'taskboard.eyebrow': '프로젝트 작업 흐름',
  'taskboard.title': '작업 보드',
  'taskboard.description': '프로젝트 작업을 독립적인 OpenCode 세션에 대기시키고 수락하기 전에 결과를 검토합니다.',
  'taskboard.project.placeholder': '프로젝트 선택',
  'taskboard.project.all': '모든 프로젝트',
  'taskboard.aggregate.partial': '일부 프로젝트 작업 보드를 불러오지 못했습니다.',
  'taskboard.actions.new': '새 작업',
  'taskboard.actions.edit': '편집',
  'taskboard.actions.delete': '삭제',
  'taskboard.actions.refresh': '새로 고침',
  'taskboard.actions.retry': '다시 시도',
  'taskboard.actions.openSession': '세션 열기',
  'taskboard.actions.run': '지금 실행',
  'taskboard.automation.label': '자동 실행',
  'taskboard.automation.description': 'Todo 상태의 작업만 자동으로 가져옵니다.',
  'taskboard.automation.enabled': '사용',
  'taskboard.automation.disabled': '사용 안 함',
  'taskboard.columns.backlog': '백로그',
  'taskboard.columns.todo': 'Todo',
  'taskboard.columns.inProgress': '진행 중',
  'taskboard.columns.inReview': '검토 중',
  'taskboard.columns.blocked': '차단됨',
  'taskboard.columns.done': '완료',
  'taskboard.status.backlog': '백로그',
  'taskboard.status.todo': 'Todo',
  'taskboard.status.in_progress': '진행 중',
  'taskboard.status.in_review': '검토 중',
  'taskboard.status.blocked': '차단됨',
  'taskboard.status.done': '완료',
  'taskboard.status.canceled': '취소됨',
  'taskboard.priority.none': '우선순위 없음',
  'taskboard.priority.urgent': '긴급',
  'taskboard.priority.high': '높음',
  'taskboard.priority.medium': '중간',
  'taskboard.priority.low': '낮음',
  'taskboard.empty.title': '아직 작업이 없습니다',
  'taskboard.loading': '작업 보드 로드 중...',
  'taskboard.empty.description': '작업을 만들고 준비되면 Todo로 옮기세요. Worker가 독립 세션을 시작합니다.',
  'taskboard.empty.column': '작업 없음',
  'taskboard.card.blockedBy': '종속 작업 대기 중',
  'taskboard.card.running': 'Agent 작업 중',
  'taskboard.card.runSucceeded': '실행 성공',
  'taskboard.card.runFailed': '실행 실패',
  'taskboard.card.scheduled': '예약됨',
  'taskboard.toast.created': '작업이 생성되었습니다',
  'taskboard.toast.moved': '작업 상태가 업데이트되었습니다',
  'taskboard.toast.runStarted': '작업 실행이 시작되었습니다',
  'taskboard.toast.failed': '작업 보드 작업에 실패했습니다',
  'taskboard.toast.updated': '작업을 업데이트했습니다',
  'taskboard.toast.deleted': '작업을 삭제했습니다',
  'taskboard.dialog.title': '작업 만들기',
  'taskboard.dialog.editTitle': '작업 편집',
  'taskboard.dialog.description': '프로젝트 작업을 추가합니다. 백로그 작업은 Todo로 옮길 때까지 수동으로 유지됩니다.',
  'taskboard.dialog.fields.title': '제목',
  'taskboard.dialog.fields.titlePlaceholder': '무엇을 해야 하나요?',
  'taskboard.dialog.fields.project': '프로젝트',
  'taskboard.dialog.fields.model': '모델',
  'taskboard.dialog.fields.agent': 'Agent',
  'taskboard.dialog.fields.goalEnabled': 'Goal 모드 사용',
  'taskboard.dialog.fields.schedule': '예약',
  'taskboard.dialog.fields.date': '날짜',
  'taskboard.dialog.fields.time': '시간',
  'taskboard.dialog.fields.timezone': '시간대',
  'taskboard.dialog.fields.context': '컨텍스트 전달',
  'taskboard.dialog.fields.sourceSession': '소스 세션',
  'taskboard.dialog.context.new': '새 세션 시작',
  'taskboard.dialog.context.fork': '세션 포크',
  'taskboard.dialog.context.handoff': '로컬 전달 문서 작성',
  'taskboard.dialog.sourceSessionPlaceholder': '제목 또는 ID로 세션 검색',
  'taskboard.dialog.sourceSessionNoResults': '일치하는 세션이 없습니다.',
  'taskboard.dialog.validation.sourceSessionRequired': '소스 세션을 선택하세요.',
  'taskboard.dialog.schedule.none': '예약 없음',
  'taskboard.dialog.schedule.once': '한 번 실행',
  'taskboard.dialog.schedule.daily': '매일',
  'taskboard.schedule.title': '예약된 작업 템플릿',
  'taskboard.schedule.description': '예약 시간이 되면 일반 작업을 생성합니다.',
  'taskboard.schedule.once': '한 번',
  'taskboard.schedule.daily': '매일',
  'taskboard.dialog.validation.projectRequired': '프로젝트를 선택하세요.',
  'taskboard.dialog.validation.modelRequired': '모델을 선택하세요.',
  'taskboard.dialog.validation.agentRequired': 'Agent를 선택하세요.',
  'taskboard.dialog.validation.goalObjectiveRequired': 'Goal 목표를 입력하세요.',
  'taskboard.dialog.fields.description': '설명',
  'taskboard.dialog.fields.descriptionPlaceholder': 'Agent를 위한 맥락과 완료 조건을 추가하세요.',
  'taskboard.dialog.fields.labels': '레이블',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp, backend, 후속 작업',
  'taskboard.dialog.fields.priority': '우선순위',
  'taskboard.dialog.fields.status': '초기 상태',
  'taskboard.dialog.actions.cancel': '취소',
  'taskboard.dialog.actions.create': '작업 만들기',
  'taskboard.dialog.actions.creating': '생성 중...',
  'taskboard.dialog.actions.save': '변경사항 저장',
  'taskboard.dialog.actions.saving': '저장 중...',
  'taskboard.project.noResults': '일치하는 프로젝트가 없습니다.',
  'taskboard.delete.title': '작업을 삭제할까요?',
  'taskboard.delete.description': '아직 시작되지 않은 작업이므로 영구적으로 삭제할 수 있습니다.',
  'taskboard.delete.cancel': '취소',
  'taskboard.delete.confirm': '작업 삭제',
  'terminalView.actions.attachSelection': '선택한 출력 첨부',
  'terminalView.actions.restart': '터미널 다시 시작',
  'terminalView.actions.uploadFiles': '현재 디렉터리에 파일 업로드',
  'terminalView.upload.success': '업로드한 파일: {count}개',
  'terminalView.upload.conflict': '기존 파일이라 덮어쓰지 않은 파일: {count}개',
  'terminalView.upload.failed': '업로드에 실패한 파일: {count}개',
  'terminalView.upload.chooseDirectory': '업로드 디렉터리 선택',
  'terminalView.upload.chooseDirectoryDescription': '파일을 저장할 서버 디렉터리를 선택하세요.',
  'terminalView.upload.currentDirectory': '서버 디렉터리',
  'terminalView.upload.parentDirectory': '상위 디렉터리로 이동',
  'terminalView.upload.selectDirectory': '이 디렉터리를 선택하고 업로드',
  'terminalView.upload.directoryLoading': '디렉터리 로드 중...',
  'terminalView.upload.directoryEmpty': '하위 디렉터리 없음',
  'terminalView.upload.directoryLoadFailed': '이 디렉터리를 불러오지 못했습니다.',
  'terminalView.upload.directoryRetry': '다시 시도',
  ...
  'settings.usage.tokenUsage.title': '토큰 사용량',
  'settings.usage.tokenUsage.today': '오늘',
  'settings.usage.tokenUsage.thisMonth': '이번 달',
  'settings.usage.tokenUsage.total': '전체',
  'settings.usage.tokenUsage.previousMonth': '이전 달',
  'settings.usage.tokenUsage.nextMonth': '다음 달',
  'settings.usage.tokenUsage.noData': '이번 달 토큰 사용량 데이터가 없습니다.',
  'settings.usage.tokenUsage.loading': '토큰 사용량을 불러오는 중...',
  'settings.usage.tokenUsage.retry': '다시 시도',
  'settings.usage.tokenUsage.timezone': '서비스 시간대: {timezone}',
  'settings.usage.tokenUsage.recentDays': '최근 14일',
  'settings.usage.tokenUsage.date': '날짜',
  'settings.usage.tokenUsage.share': '비율',
  'settings.usage.tokenUsage.modelShare': '비율: {percent}%',
  'settings.usage.tokenUsage.modelDetails': '모델 세부 정보',
  'settings.usage.tokenUsage.modelDetailsForDate': '{date} 모델 세부 정보',
  'settings.usage.tokenUsage.providerModel': '제공자 / 모델',
  'settings.usage.tokenUsage.selectDate': '{date} 토큰 세부 정보 표시',
  'settings.usage.tokenUsage.noModelDetails': '이 날짜에는 모델 세부 정보가 없습니다.',
  ...
  'chat.sessionMetrics.tokens': '세션 사용량',
