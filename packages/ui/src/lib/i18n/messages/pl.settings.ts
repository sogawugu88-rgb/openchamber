...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.showSessionTokenDetailsAria': 'Pokaż szczegóły tokenów sesji w Composerze',
  'settings.openchamber.visual.field.showSessionTokenDetails': 'Pokaż szczegóły tokenów sesji',
  'settings.openchamber.visual.field.showSessionTokenDetailsInfo': 'Pokaż statystyki tokenów i czasu pod Composerem po odpowiedzi.',
  ...
  'settings.openchamber.visual.autoContinue.sectionTitle': 'Automatyczna kontynuacja',
  'settings.openchamber.visual.autoContinue.description': 'Gdy limit dostawcy zakończy turę, OpenChamber może wysłać w tej samej sesji nową syntetyczną wiadomość kontynuującą. Dotyczy to tylko zwykłych rozmów, a nie trybu celu.',
  'settings.openchamber.visual.autoContinue.enabled': 'Automatycznie kontynuuj po limitach dostawcy',
  'settings.openchamber.visual.autoContinue.enabledAria': 'Automatycznie kontynuuj zwykłe rozmowy po limicie dostawcy',
  'settings.openchamber.visual.autoContinue.maxRetries': 'Maksymalna liczba wiadomości kontynuacji',
  'settings.openchamber.visual.autoContinue.maxRetriesInfo': 'OpenChamber wysyła skonfigurowaną liczbę nowych wiadomości kontynuacji dla jednej ograniczonej tury. Wartość domyślna to 5; ustaw 0, aby wyłączyć automatyczne odzyskiwanie.',
  'settings.openchamber.visual.autoContinue.maxRetriesAria': 'Maksymalna liczba automatycznych wiadomości kontynuacji',
  'settings.openchamber.visual.autoContinue.prompt': 'Wiadomość kontynuacji',
  'settings.openchamber.visual.autoContinue.promptInfo': 'Ta wiadomość jest wysyłana jako syntetyczna wiadomość użytkownika po błędzie limitu. Pozostaw puste, aby użyć wbudowanej wiadomości.',
  'settings.openchamber.visual.autoContinue.promptPlaceholder': 'Pozostaw puste, aby użyć domyślnej wiadomości kontynuacji',
  'settings.openchamber.visual.autoContinue.promptAria': 'Wiadomość wysyłana po limicie dostawcy w celu kontynuacji',
  'settings.openchamber.visual.goal.auditFailureLimitLabel': 'Błędy audytu przed zablokowaniem',
  'settings.openchamber.visual.goal.auditFailureLimitAria': 'Liczba kolejnych błędów audytu celu tolerowanych przed zablokowaniem',
  'settings.openchamber.visual.goal.auditFailureLimitDescription': 'Określa, ile kolejnych niedostępnych lub ograniczonych limitami wywołań audytu toleruje Goal Mode przed zablokowaniem. Zakres: od 1 do 20.',
  'settings.openchamber.visual.codeServer.sectionTitle': 'Zdalny code-server',
  'settings.openchamber.visual.codeServer.label': 'Bazowy URL',
  'settings.openchamber.visual.codeServer.aria': 'Bazowy URL zdalnego code-servera',
  'settings.openchamber.visual.codeServer.description': 'Ustaw bazowy URL zdalnego code-servera. Bieżący katalog projektu zostanie dodany jako parametr folder podczas otwierania.',
