...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.autoContinue.sectionTitle": "Continuação automática",
  "settings.openchamber.visual.autoContinue.description": "Quando um limite do provedor encerra um turno, o OpenChamber pode enviar uma nova mensagem sintética de continuação na mesma sessão. Isso se aplica apenas a conversas normais, não ao modo de objetivo.",
  "settings.openchamber.visual.autoContinue.enabled": "Continuar automaticamente após limites do provedor",
  "settings.openchamber.visual.autoContinue.enabledAria": "Continuar automaticamente conversas normais após um limite do provedor",
  "settings.openchamber.visual.autoContinue.maxRetries": "Máximo de mensagens de continuação",
  "settings.openchamber.visual.autoContinue.maxRetriesInfo": "O OpenChamber envia o número configurado de novas mensagens de continuação para cada turno limitado. O padrão é 5; defina 0 para desativar a recuperação automática.",
  "settings.openchamber.visual.autoContinue.maxRetriesAria": "Máximo de mensagens de continuação automática",
  "settings.openchamber.visual.autoContinue.prompt": "Mensagem de continuação",
  "settings.openchamber.visual.autoContinue.promptInfo": "Esta mensagem é enviada como uma mensagem de usuário sintética após uma falha por limite. Deixe em branco para usar a mensagem integrada.",
  "settings.openchamber.visual.autoContinue.promptPlaceholder": "Deixe em branco para usar a mensagem de continuação padrão",
  "settings.openchamber.visual.autoContinue.promptAria": "Mensagem enviada para continuar após um limite do provedor",
  "settings.openchamber.visual.goal.auditFailureLimitLabel": "Falhas de auditoria antes de bloquear",
  "settings.openchamber.visual.goal.auditFailureLimitAria": "Número de falhas consecutivas da auditoria do Goal toleradas antes do bloqueio",
  "settings.openchamber.visual.goal.auditFailureLimitDescription": "Controla quantas chamadas consecutivas de auditoria indisponíveis ou limitadas são toleradas pelo Goal Mode antes de bloquear. Intervalo: 1 a 20.",
  "settings.openchamber.visual.codeServer.sectionTitle": "code-server na nuvem",
  "settings.openchamber.visual.codeServer.label": "URL base",
  "settings.openchamber.visual.codeServer.aria": "URL base do code-server na nuvem",
  "settings.openchamber.visual.codeServer.description": "Defina a URL base do code-server na nuvem. O diretório do projeto atual é adicionado como parâmetro folder ao abrir.",
  ...
  "settings.openchamber.visual.field.showSessionTokenDetailsAria": "Mostrar detalhes dos tokens da sessão no Composer",
  "settings.openchamber.visual.field.showSessionTokenDetails": "Mostrar detalhes dos tokens da sessão",
  "settings.openchamber.visual.field.showSessionTokenDetailsInfo": "Mostrar as métricas de tokens e tempo abaixo do Composer após uma resposta.",
