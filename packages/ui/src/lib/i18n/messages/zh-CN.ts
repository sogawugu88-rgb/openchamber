...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'taskboard.eyebrow': '项目工作流',
  'taskboard.title': '任务看板',
  'taskboard.description': '将项目任务交给独立的 OpenCode 会话执行，并在接受前检查结果。',
  'taskboard.project.placeholder': '选择项目',
  'taskboard.project.all': '所有项目',
  'taskboard.aggregate.partial': '部分项目的任务看板加载失败。',
  'taskboard.actions.new': '新建任务',
  'taskboard.actions.edit': '编辑',
  'taskboard.actions.delete': '删除',
  'taskboard.actions.refresh': '刷新',
  'taskboard.actions.retry': '重试',
  'taskboard.actions.openSession': '打开会话',
  'taskboard.actions.run': '立即执行',
  'taskboard.automation.label': '自动执行',
  'taskboard.automation.description': '只有 Todo 状态的任务会被自动领取。',
  'taskboard.automation.enabled': '已启用',
  'taskboard.automation.disabled': '已禁用',
  'taskboard.columns.backlog': '待规划',
  'taskboard.columns.todo': '待处理',
  'taskboard.columns.inProgress': '进行中',
  'taskboard.columns.inReview': '待审核',
  'taskboard.columns.blocked': '已阻塞',
  'taskboard.columns.done': '已完成',
  'taskboard.status.backlog': '待规划',
  'taskboard.status.todo': '待处理',
  'taskboard.status.in_progress': '进行中',
  'taskboard.status.in_review': '待审核',
  'taskboard.status.blocked': '已阻塞',
  ...
  'taskboard.empty.title': '还没有任务',
  'taskboard.loading': '正在加载任务看板...',
  'taskboard.empty.description': '创建任务，准备好后移到待处理，Worker 会启动独立会话执行。',
  'taskboard.empty.column': '暂无任务',
  'taskboard.card.blockedBy': '等待依赖任务完成',
  'taskboard.card.running': 'Agent 正在工作',
  'taskboard.card.runSucceeded': '执行成功',
  'taskboard.card.runFailed': '执行失败',
  'taskboard.card.scheduled': '已计划',
  'taskboard.toast.created': '任务已创建',
  'taskboard.toast.moved': '任务状态已更新',
  'taskboard.toast.runStarted': '任务已开始执行',
  'taskboard.toast.failed': '看板操作失败',
  'taskboard.toast.updated': '任务已更新',
  'taskboard.toast.deleted': '任务已删除',
  'taskboard.dialog.title': '创建任务',
  'taskboard.dialog.editTitle': '编辑任务',
  'taskboard.dialog.description': '添加项目任务。任务在移到待处理前不会自动执行。',
  'taskboard.dialog.fields.title': '标题',
  'taskboard.dialog.fields.titlePlaceholder': '需要完成什么？',
  'taskboard.dialog.fields.project': '项目',
  'taskboard.dialog.fields.model': '模型',
  'taskboard.dialog.fields.agent': 'Agent',
  'taskboard.dialog.fields.goalEnabled': '启用目标模式',
  'taskboard.dialog.fields.schedule': '计划执行',
  'taskboard.dialog.fields.date': '日期',
  'taskboard.dialog.fields.time': '时间',
  'taskboard.dialog.fields.timezone': '时区',
  'taskboard.dialog.fields.context': '上下文承接',
  'taskboard.dialog.fields.sourceSession': '来源会话',
  'taskboard.dialog.context.new': '启动新会话',
  'taskboard.dialog.context.fork': 'Fork 会话',
  'taskboard.dialog.context.handoff': '写入本地交接文档',
  'taskboard.dialog.sourceSessionPlaceholder': '按标题或 ID 搜索会话',
  'taskboard.dialog.sourceSessionNoResults': '没有匹配的会话。',
  'taskboard.dialog.validation.sourceSessionRequired': '请选择来源会话。',
  'taskboard.dialog.schedule.none': '不设置计划',
  'taskboard.dialog.schedule.once': '执行一次',
  'taskboard.dialog.schedule.daily': '每天',
  'taskboard.schedule.title': '计划任务模板',
  'taskboard.schedule.description': '到达计划时间后，这些模板会创建普通任务。',
  'taskboard.schedule.once': '一次性',
  'taskboard.schedule.daily': '每天',
  'taskboard.dialog.validation.projectRequired': '请选择项目。',
  'taskboard.dialog.validation.modelRequired': '请选择模型。',
  'taskboard.dialog.validation.agentRequired': '请选择 Agent。',
  'taskboard.dialog.validation.goalObjectiveRequired': '请输入目标内容。',
  'taskboard.dialog.fields.description': '描述',
  'taskboard.dialog.fields.descriptionPlaceholder': '补充 Agent 需要的上下文和验收条件。',
  'taskboard.dialog.fields.labels': '标签',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp、后端、后续处理',
  'taskboard.dialog.fields.priority': '优先级',
  'taskboard.dialog.fields.status': '初始状态',
  'taskboard.dialog.actions.cancel': '取消',
  'taskboard.dialog.actions.create': '创建任务',
  'taskboard.dialog.actions.creating': '创建中...',
  'taskboard.dialog.actions.save': '保存更改',
  'taskboard.dialog.actions.saving': '保存中...',
  'taskboard.project.noResults': '没有匹配的项目。',
  'taskboard.delete.title': '删除任务？',
  'taskboard.delete.description': '此任务尚未启动，可以永久删除。',
  'taskboard.delete.cancel': '取消',
  'taskboard.delete.confirm': '删除任务',
  'terminalView.actions.attachSelection': '附加所选输出',
  'terminalView.actions.restart': '重启终端',
  'terminalView.actions.uploadFiles': '上传文件到当前目录',
  'terminalView.upload.success': '已上传文件：{count}。',
  'terminalView.upload.conflict': '已存在且未覆盖的文件：{count}。',
  'terminalView.upload.failed': '上传失败的文件：{count}。',
  'terminalView.upload.chooseDirectory': '选择上传目录',
  'terminalView.upload.chooseDirectoryDescription': '选择用于存放文件的服务器目录。',
  'terminalView.upload.currentDirectory': '服务器目录',
  'terminalView.upload.parentDirectory': '返回上级目录',
  'terminalView.upload.selectDirectory': '选择此目录并上传',
  'terminalView.upload.directoryLoading': '正在加载目录...',
  'terminalView.upload.directoryEmpty': '没有子目录',
  'terminalView.upload.directoryLoadFailed': '无法加载此目录。',
  'terminalView.upload.directoryRetry': '重试',
  ...
  'settings.usage.tokenUsage.title': '令牌用量',
  'settings.usage.tokenUsage.today': '今天',
  'settings.usage.tokenUsage.thisMonth': '本月',
  'settings.usage.tokenUsage.total': '总计',
  'settings.usage.tokenUsage.previousMonth': '上个月',
  'settings.usage.tokenUsage.nextMonth': '下个月',
  'settings.usage.tokenUsage.noData': '本月没有令牌用量数据。',
  'settings.usage.tokenUsage.loading': '正在加载令牌用量...',
  'settings.usage.tokenUsage.retry': '重试',
  'settings.usage.tokenUsage.timezone': '服务时区：{timezone}',
  'settings.usage.tokenUsage.recentDays': '最近 14 天',
  'settings.usage.tokenUsage.date': '日期',
  'settings.usage.tokenUsage.share': '占比',
  'settings.usage.tokenUsage.modelShare': '占比：{percent}%',
  'settings.usage.tokenUsage.modelDetails': '模型详情',
  'settings.usage.tokenUsage.modelDetailsForDate': '{date} 的模型详情',
  'settings.usage.tokenUsage.providerModel': '提供商 / 模型',
  'settings.usage.tokenUsage.selectDate': '显示 {date} 的 Token 详情',
  'settings.usage.tokenUsage.noModelDetails': '这一天没有模型详情。',
  ...
  'chat.sessionMetrics.tokens': '会话消耗',
  ...
  'chat.sessionMetrics.cache': '缓存',
  'chat.sessionMetrics.speed': '令牌/秒',
