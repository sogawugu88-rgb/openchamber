...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'taskboard.eyebrow': 'プロジェクトの作業フロー',
  'taskboard.title': 'タスクボード',
  'taskboard.description': 'プロジェクトの作業を独立した OpenCode セッションに送り、受け入れる前に結果を確認します。',
  'taskboard.project.placeholder': 'プロジェクトを選択',
  'taskboard.project.all': 'すべてのプロジェクト',
  'taskboard.aggregate.partial': '一部のプロジェクトボードを読み込めませんでした。',
  'taskboard.actions.new': '新しいタスク',
  'taskboard.actions.edit': '編集',
  'taskboard.actions.delete': '削除',
  'taskboard.actions.refresh': '更新',
  'taskboard.actions.retry': '再試行',
  'taskboard.actions.openSession': 'セッションを開く',
  'taskboard.actions.run': '今すぐ実行',
  'taskboard.automation.label': '自動実行',
  'taskboard.automation.description': 'Todo のタスクだけが自動的に取得されます。',
  'taskboard.automation.enabled': '有効',
  'taskboard.automation.disabled': '無効',
  'taskboard.columns.backlog': 'バックログ',
  'taskboard.columns.todo': 'Todo',
  'taskboard.columns.inProgress': '進行中',
  'taskboard.columns.inReview': 'レビュー中',
  'taskboard.columns.blocked': 'ブロック中',
  'taskboard.columns.done': '完了',
  'taskboard.status.backlog': 'バックログ',
  'taskboard.status.todo': 'Todo',
  'taskboard.status.in_progress': '進行中',
  'taskboard.status.in_review': 'レビュー中',
  'taskboard.status.blocked': 'ブロック中',
  'taskboard.status.done': '完了',
  'taskboard.status.canceled': 'キャンセル済み',
  'taskboard.priority.none': '優先度なし',
  'taskboard.priority.urgent': '緊急',
  'taskboard.priority.high': '高',
  'taskboard.priority.medium': '中',
  'taskboard.priority.low': '低',
  'taskboard.empty.title': 'タスクはまだありません',
  'taskboard.loading': 'タスクボードを読み込み中...',
  'taskboard.empty.description': 'タスクを作成して、準備ができたら Todo に移動します。Worker が独立したセッションを開始します。',
  'taskboard.empty.column': 'タスクなし',
  'taskboard.card.blockedBy': '依存タスクを待機中',
  'taskboard.card.running': 'Agent が作業中',
  'taskboard.card.runSucceeded': '実行成功',
  'taskboard.card.runFailed': '実行失敗',
  'taskboard.card.scheduled': '予定',
  'taskboard.toast.created': 'タスクを作成しました',
  'taskboard.toast.moved': 'タスクの状態を更新しました',
  'taskboard.toast.runStarted': 'タスクの実行を開始しました',
  'taskboard.toast.failed': 'タスクボード操作に失敗しました',
  'taskboard.toast.updated': 'タスクを更新しました',
  'taskboard.toast.deleted': 'タスクを削除しました',
  'taskboard.dialog.title': 'タスクを作成',
  'taskboard.dialog.editTitle': 'タスクを編集',
  'taskboard.dialog.description': 'プロジェクトのタスクを追加します。Backlog のタスクは Todo に移動するまで手動です。',
  'taskboard.dialog.fields.title': 'タイトル',
  'taskboard.dialog.fields.titlePlaceholder': '何を完了する必要がありますか？',
  'taskboard.dialog.fields.project': 'プロジェクト',
  'taskboard.dialog.fields.model': 'モデル',
  'taskboard.dialog.fields.agent': 'Agent',
  'taskboard.dialog.fields.goalEnabled': 'Goal モードを有効化',
  'taskboard.dialog.fields.schedule': 'スケジュール',
  'taskboard.dialog.fields.date': '日付',
  'taskboard.dialog.fields.time': '時刻',
  'taskboard.dialog.fields.timezone': 'タイムゾーン',
  'taskboard.dialog.fields.context': 'コンテキストの引き継ぎ',
  'taskboard.dialog.fields.sourceSession': 'ソースセッション',
  'taskboard.dialog.context.new': '新しいセッションを開始',
  'taskboard.dialog.context.fork': 'セッションをフォーク',
  'taskboard.dialog.context.handoff': 'ローカル引き継ぎを作成',
  'taskboard.dialog.sourceSessionPlaceholder': 'タイトルまたは ID で検索',
  'taskboard.dialog.sourceSessionNoResults': '一致するセッションはありません。',
  'taskboard.dialog.validation.sourceSessionRequired': 'ソースセッションを選択してください。',
  'taskboard.dialog.schedule.none': 'スケジュールなし',
  'taskboard.dialog.schedule.once': '一度だけ実行',
  'taskboard.dialog.schedule.daily': '毎日',
  'taskboard.schedule.title': 'スケジュール済みタスクテンプレート',
  'taskboard.schedule.description': '予定時刻になると通常のタスクを作成します。',
  'taskboard.schedule.once': '一度のみ',
  'taskboard.schedule.daily': '毎日',
  'taskboard.dialog.validation.projectRequired': 'プロジェクトを選択してください。',
  'taskboard.dialog.validation.modelRequired': 'モデルを選択してください。',
  'taskboard.dialog.validation.agentRequired': 'Agent を選択してください。',
  'taskboard.dialog.validation.goalObjectiveRequired': 'Goal の目標を入力してください。',
  'taskboard.dialog.fields.description': '説明',
  'taskboard.dialog.fields.descriptionPlaceholder': 'Agent 向けの文脈と受け入れ条件を追加します。',
  'taskboard.dialog.fields.labels': 'ラベル',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp, backend, follow-up',
  'taskboard.dialog.fields.priority': '優先度',
  'taskboard.dialog.fields.status': '初期状態',
  'taskboard.dialog.actions.cancel': 'キャンセル',
  'taskboard.dialog.actions.create': 'タスクを作成',
  'taskboard.dialog.actions.creating': '作成中...',
  'taskboard.dialog.actions.save': '変更を保存',
  'taskboard.dialog.actions.saving': '保存中...',
  'taskboard.project.noResults': '一致するプロジェクトはありません。',
  'taskboard.delete.title': 'タスクを削除しますか？',
  'taskboard.delete.description': 'このタスクはまだ開始されていないため、完全に削除できます。',
  'taskboard.delete.cancel': 'キャンセル',
  'taskboard.delete.confirm': 'タスクを削除',
  'terminalView.actions.attachSelection': '選択した出力を添付',
  'terminalView.actions.restart': 'ターミナルを再起動',
  'terminalView.actions.uploadFiles': '現在のディレクトリにファイルをアップロード',
  'terminalView.upload.success': 'アップロードしたファイル: {count}',
  'terminalView.upload.conflict': '既存のため上書きしなかったファイル: {count}',
  'terminalView.upload.failed': 'アップロードに失敗したファイル: {count}',
  'terminalView.upload.chooseDirectory': 'アップロード先のディレクトリを選択',
  'terminalView.upload.chooseDirectoryDescription': 'ファイルを置くサーバー上のディレクトリを選択してください。',
  'terminalView.upload.currentDirectory': 'サーバーディレクトリ',
  'terminalView.upload.parentDirectory': '親ディレクトリへ移動',
  'terminalView.upload.selectDirectory': 'このディレクトリを選択してアップロード',
  'terminalView.upload.directoryLoading': 'ディレクトリを読み込み中...',
  'terminalView.upload.directoryEmpty': 'サブディレクトリはありません',
  'terminalView.upload.directoryLoadFailed': 'このディレクトリを読み込めませんでした。',
  'terminalView.upload.directoryRetry': '再試行',
  ...
  'settings.usage.tokenUsage.title': 'トークン使用量',
  'settings.usage.tokenUsage.today': '今日',
  'settings.usage.tokenUsage.thisMonth': '今月',
  'settings.usage.tokenUsage.total': '合計',
  'settings.usage.tokenUsage.previousMonth': '前の月',
  'settings.usage.tokenUsage.nextMonth': '次の月',
  'settings.usage.tokenUsage.noData': '今月のトークン使用量データはありません。',
  'settings.usage.tokenUsage.loading': 'トークン使用量を読み込み中...',
  'settings.usage.tokenUsage.retry': '再試行',
  'settings.usage.tokenUsage.timezone': 'サービスのタイムゾーン: {timezone}',
  'settings.usage.tokenUsage.recentDays': '直近14日間',
  'settings.usage.tokenUsage.date': '日付',
  'settings.usage.tokenUsage.share': '割合',
  'settings.usage.tokenUsage.modelShare': '割合: {percent}%',
  'settings.usage.tokenUsage.modelDetails': 'モデルの詳細',
  'settings.usage.tokenUsage.modelDetailsForDate': '{date} のモデル詳細',
  'settings.usage.tokenUsage.providerModel': 'プロバイダー / モデル',
  'settings.usage.tokenUsage.selectDate': '{date} のトークン詳細を表示',
  'settings.usage.tokenUsage.noModelDetails': 'この日のモデル詳細はありません。',
  ...
  'chat.sessionMetrics.tokens': 'セッション使用量',
  ...
  'chat.sessionMetrics.cache': 'キャッシュ',
