...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.autoContinue.sectionTitle': '자동 계속',
  'settings.openchamber.visual.autoContinue.description': '프로바이더의 rate limit으로 턴이 종료되면 OpenChamber가 같은 세션에 새로운 합성 계속 메시지를 보낼 수 있습니다. 일반 대화에만 적용되며 Goal Mode에는 적용되지 않습니다.',
  'settings.openchamber.visual.autoContinue.enabled': 'rate limit 후 자동으로 계속',
  'settings.openchamber.visual.autoContinue.enabledAria': '프로바이더 rate limit 후 일반 대화를 자동으로 계속',
  'settings.openchamber.visual.autoContinue.maxRetries': '최대 계속 메시지 수',
  'settings.openchamber.visual.autoContinue.maxRetriesInfo': '한 번의 rate limit 턴에 대해 OpenChamber가 설정한 수만큼 새 계속 메시지를 보냅니다. 기본값은 5이며, 0으로 설정하면 자동 복구 메시지를 비활성화합니다.',
  'settings.openchamber.visual.autoContinue.maxRetriesAria': '자동 계속 메시지 최대 수',
  'settings.openchamber.visual.autoContinue.prompt': '계속 메시지',
  'settings.openchamber.visual.autoContinue.promptInfo': '이 메시지는 rate limit 오류 후 합성 사용자 메시지로 전송됩니다. 비워 두면 기본 메시지를 사용합니다.',
  'settings.openchamber.visual.autoContinue.promptPlaceholder': '기본 계속 메시지를 사용하려면 비워 두세요',
  'settings.openchamber.visual.autoContinue.promptAria': '프로바이더 rate limit 후 계속하기 위해 전송할 메시지',
  'settings.openchamber.visual.goal.auditFailureLimitLabel': '차단 전 감사 실패 횟수',
  'settings.openchamber.visual.goal.auditFailureLimitAria': '차단 전에 허용되는 연속 Goal 감사 실패 횟수',
  'settings.openchamber.visual.goal.auditFailureLimitDescription': 'Goal Mode가 차단되기 전에 감사 불가 또는 속도 제한이 발생한 연속 감사 호출을 몇 번 허용할지 설정합니다. 범위: 1~20.',
  'settings.openchamber.visual.codeServer.sectionTitle': '클라우드 code-server',
  'settings.openchamber.visual.codeServer.label': '기본 URL',
  'settings.openchamber.visual.codeServer.aria': '클라우드 code-server 기본 URL',
  'settings.openchamber.visual.codeServer.description': '클라우드 code-server의 기본 URL을 설정합니다. 열 때 현재 프로젝트 디렉터리가 folder 매개변수로 추가됩니다.',
  ...
  'settings.openchamber.visual.field.showSessionTokenDetailsAria': 'Composer에 세션 토큰 세부 정보 표시',
  'settings.openchamber.visual.field.showSessionTokenDetails': '세션 토큰 세부 정보 표시',
  'settings.openchamber.visual.field.showSessionTokenDetailsInfo': '응답 후 Composer 아래에 토큰 및 시간 지표를 표시합니다.',
