...
export const dict: Record<I18nKey, string> = {
  ...settingsDict,
  'taskboard.eyebrow': 'Flujo del proyecto',
  'taskboard.title': 'Tablero de tareas',
  'taskboard.description': 'Coloca el trabajo del proyecto en sesiones independientes de OpenCode y revisa el resultado antes de aceptarlo.',
  'taskboard.project.placeholder': 'Elegir proyecto',
  'taskboard.project.all': 'Todos los proyectos',
  'taskboard.aggregate.partial': 'No se pudieron cargar algunos tableros de proyecto.',
  'taskboard.actions.new': 'Nueva tarea',
  'taskboard.actions.edit': 'Editar',
  'taskboard.actions.delete': 'Eliminar',
  'taskboard.actions.refresh': 'Actualizar',
  'taskboard.actions.retry': 'Reintentar',
  'taskboard.actions.openSession': 'Abrir sesión',
  'taskboard.actions.run': 'Ejecutar ahora',
  'taskboard.automation.label': 'Ejecución automática',
  'taskboard.automation.description': 'Solo se recogen automáticamente las tareas en Todo.',
  'taskboard.automation.enabled': 'Activada',
  'taskboard.automation.disabled': 'Desactivada',
  'taskboard.columns.backlog': 'Backlog',
  'taskboard.columns.todo': 'Todo',
  'taskboard.columns.inProgress': 'En progreso',
  'taskboard.columns.inReview': 'En revisión',
  'taskboard.columns.blocked': 'Bloqueada',
  'taskboard.columns.done': 'Hecha',
  'taskboard.status.backlog': 'Backlog',
  'taskboard.status.todo': 'Todo',
  'taskboard.status.in_progress': 'En progreso',
  'taskboard.status.in_review': 'En revisión',
  'taskboard.status.blocked': 'Bloqueada',
  'taskboard.status.done': 'Hecha',
  'taskboard.status.canceled': 'Cancelada',
  'taskboard.priority.none': 'Sin prioridad',
  'taskboard.priority.urgent': 'Urgente',
  'taskboard.priority.high': 'Alta',
  'taskboard.priority.medium': 'Media',
  'taskboard.priority.low': 'Baja',
  'taskboard.empty.title': 'Aún no hay tareas',
  'taskboard.loading': 'Cargando tablero de tareas...',
  'taskboard.empty.description': 'Crea una tarea, muévela a Todo cuando esté lista y deja que el worker inicie una sesión independiente.',
  'taskboard.empty.column': 'Sin tareas',
  'taskboard.card.blockedBy': 'Esperando dependencias',
  'taskboard.card.running': 'El agente está trabajando',
  'taskboard.card.runSucceeded': 'Ejecución completada',
  'taskboard.card.runFailed': 'Ejecución fallida',
  'taskboard.card.scheduled': 'Programada',
  'taskboard.toast.created': 'Tarea creada',
  'taskboard.toast.moved': 'Estado de tarea actualizado',
  'taskboard.toast.runStarted': 'Ejecución de tarea iniciada',
  'taskboard.toast.failed': 'La acción del tablero falló',
  'taskboard.toast.updated': 'Tarea actualizada',
  'taskboard.toast.deleted': 'Tarea eliminada',
  'taskboard.dialog.title': 'Crear tarea',
  'taskboard.dialog.editTitle': 'Editar tarea',
  'taskboard.dialog.description': 'Añade una tarea del proyecto. Las tareas en Backlog son manuales hasta que las muevas a Todo.',
  'taskboard.dialog.fields.title': 'Título',
  'taskboard.dialog.fields.titlePlaceholder': '¿Qué hay que hacer?',
  'taskboard.dialog.fields.project': 'Proyecto',
  'taskboard.dialog.fields.model': 'Modelo',
  'taskboard.dialog.fields.agent': 'Agente',
  'taskboard.dialog.fields.goalEnabled': 'Activar el modo Goal',
  'taskboard.dialog.fields.schedule': 'Programación',
  'taskboard.dialog.fields.date': 'Fecha',
  'taskboard.dialog.fields.time': 'Hora',
  'taskboard.dialog.fields.timezone': 'Zona horaria',
  'taskboard.dialog.fields.context': 'Transferencia de contexto',
  'taskboard.dialog.fields.sourceSession': 'Sesión de origen',
  'taskboard.dialog.context.new': 'Iniciar una sesión nueva',
  'taskboard.dialog.context.fork': 'Bifurcar una sesión',
  'taskboard.dialog.context.handoff': 'Escribir una transferencia local',
  'taskboard.dialog.sourceSessionPlaceholder': 'Buscar sesiones por título o ID',
  'taskboard.dialog.sourceSessionNoResults': 'No hay sesiones coincidentes.',
  'taskboard.dialog.validation.sourceSessionRequired': 'Elige una sesión de origen.',
  'taskboard.dialog.schedule.none': 'Sin programación',
  'taskboard.dialog.schedule.once': 'Ejecutar una vez',
  'taskboard.dialog.schedule.daily': 'Cada día',
  'taskboard.schedule.title': 'Plantillas de tareas programadas',
  'taskboard.schedule.description': 'Estas plantillas crean tareas normales cuando llega su hora.',
  'taskboard.schedule.once': 'Una vez',
  'taskboard.schedule.daily': 'Diaria',
  'taskboard.dialog.validation.projectRequired': 'Elige un proyecto.',
  'taskboard.dialog.validation.modelRequired': 'Elige un modelo.',
  'taskboard.dialog.validation.agentRequired': 'Elige un agente.',
  'taskboard.dialog.validation.goalObjectiveRequired': 'Escribe el objetivo de Goal.',
  'taskboard.dialog.fields.description': 'Descripción',
  'taskboard.dialog.fields.descriptionPlaceholder': 'Añade contexto y criterios de aceptación para el agente.',
  'taskboard.dialog.fields.labels': 'Etiquetas',
  'taskboard.dialog.fields.labelsPlaceholder': 'mvp, backend, seguimiento',
  'taskboard.dialog.fields.priority': 'Prioridad',
  'taskboard.dialog.fields.status': 'Estado inicial',
  'taskboard.dialog.actions.cancel': 'Cancelar',
  'taskboard.dialog.actions.create': 'Crear tarea',
  'taskboard.dialog.actions.creating': 'Creando...',
  'taskboard.dialog.actions.save': 'Guardar cambios',
  'taskboard.dialog.actions.saving': 'Guardando...',
  'taskboard.project.noResults': 'No hay proyectos coincidentes.',
  'taskboard.delete.title': '¿Eliminar tarea?',
  'taskboard.delete.description': 'Esta tarea aún no ha comenzado y se puede eliminar permanentemente.',
  'taskboard.delete.cancel': 'Cancelar',
  'taskboard.delete.confirm': 'Eliminar tarea',
  'terminalView.actions.attachSelection': 'Adjuntar salida seleccionada',
  'terminalView.actions.restart': 'Reiniciar terminal',
  'terminalView.actions.uploadFiles': 'Subir archivos al directorio actual',
  'terminalView.upload.success': 'Archivos subidos: {count}.',
  'terminalView.upload.conflict': 'Archivos existentes no sobrescritos: {count}.',
  'terminalView.upload.failed': 'Fallos de carga: {count}.',
  'terminalView.upload.chooseDirectory': 'Elegir directorio de carga',
  'terminalView.upload.chooseDirectoryDescription': 'Selecciona un directorio del servidor para los archivos.',
  'terminalView.upload.currentDirectory': 'Directorio del servidor',
  'terminalView.upload.parentDirectory': 'Ir al directorio principal',
  'terminalView.upload.selectDirectory': 'Elegir este directorio y cargar',
  'terminalView.upload.directoryLoading': 'Cargando directorios...',
  'terminalView.upload.directoryEmpty': 'No hay subdirectorios',
  'terminalView.upload.directoryLoadFailed': 'No se pudo cargar este directorio.',
  'terminalView.upload.directoryRetry': 'Reintentar',
  ...
  "settings.usage.tokenUsage.today": "Hoy",
  "settings.usage.tokenUsage.thisMonth": "Este mes",
  "settings.usage.tokenUsage.total": "Total",
  "settings.usage.tokenUsage.previousMonth": "Mes anterior",
  "settings.usage.tokenUsage.nextMonth": "Mes siguiente",
  "settings.usage.tokenUsage.noData": "No hay datos de uso de tokens para este mes.",
  "settings.usage.tokenUsage.loading": "Cargando uso de tokens...",
  "settings.usage.tokenUsage.retry": "Reintentar",
  "settings.usage.tokenUsage.timezone": "Zona horaria del servicio: {timezone}",
  "settings.usage.tokenUsage.recentDays": "Últimos 14 días",
  "settings.usage.tokenUsage.date": "Fecha",
  "settings.usage.tokenUsage.share": "Proporción",
  "settings.usage.tokenUsage.modelShare": "Proporción: {percent}%",
  "settings.usage.tokenUsage.modelDetails": "Detalles del modelo",
  "settings.usage.tokenUsage.modelDetailsForDate": "Detalles del modelo para {date}",
  "settings.usage.tokenUsage.providerModel": "Proveedor / modelo",
  "settings.usage.tokenUsage.selectDate": "Mostrar detalles de tokens para {date}",
  "settings.usage.tokenUsage.noModelDetails": "No hay detalles del modelo para esta fecha.",
  ...
  "chat.sessionMetrics.tokens": "Uso de la sesión",
  ...
  "chat.sessionMetrics.cache": "Caché",
